...
`,pe=`# The W4 Protocol: Fractal Architecture & Civilizational Infrastructure
...
`,me=`# YouMeOS Federated Identity Architecture
...
`,fe=`# Sovereignty Box Architecture & Value Ladder
...
`,ve=`# Dirt: The Distributed Digital Mineral Economy
...
`,be=`# The Godhead Progression: Thoth, Qabalah, & The 10-Layer Lineage
...
`,we=`# The W4 Protocol: A 4D Fractal Economic Operating System
...
`,Se=`# YouMeOS: The Decentralized Operating System of the Internet
...
`,Te=`# YouMeOS Taxonomy & Terminology
...
`,xe=`# Software Manager (Compass Suite)
...
`,Ie=`# Magic Mirror: Competitive Benchmarking & Performance Analytics
...
`,Be=`# Magic Door — Multi-Theme Domain Mapping
...
`,Ge=`# The Hall of the Gods Ecosystem Architecture
...
| **Midnight Nerd** | Terminal / Console | Command-line interface and screensaver. |
...
| **Lemon Aid** | Support / Help Desk | User support and ticketing system. |
...
`,Ye=`# Helios Modules Documentation
...
`,Xe=`# Spark Federation Protocol & Security Architecture
...
`,Ke=`# YouMeOS: The Asynchronous Cosmos
...
`,$e=`# YouMeOS: The Sovereign Node Architecture
...
`,Je=`# YouMeOS: Sovereign Identity Architecture 
...
`,ln=`# Three.js Legacy Migration Guide
...
`,un=`# WebGPU Shader Migration Plan
...
`,hn=`# Window Management & Workspace Orchestration Roadmap
...
`,pn=`# YouMeOS Decentralization & Local-First Architecture Roadmap
...
## Details
This spark operates natively within the YouMeOS environment, providing seamless integration with the glassmorphic desktop and True North aesthetics.
`,at=`# Getting Started with YouMeOS
...
`,ot=`# The Swiss Army Knife for Life
...
- Selection clears on mode switch or folder navigation
`,st=["innerHTML"],rt=$({__name:"x-markdown",props:{content:{}},setup(F){const b=F,p=_(()=>b.content?ae.parse(b.content):"");return(w,r)=>(g(),A("div",{class:"x-markdown-container",innerHTML:p.value},null,8,st))}}),lt=K(rt,[["__scopeId","data-v-c9651a1d"]]),dt=80,k=150,Q=200,ct=$({__name:"enchiridion-canvas",setup(F){const b=R(null);let p=0,w=null;function r(o,i){const y=Math.random()>.85;return{x:Math.random()*o,y:Math.random()*i,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:y?3+Math.random()*3:1+Math.random()*1.5,baseRadius:y?3.5:1.5,hue:y?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}return oe(()=>{const o=b.value;if(!o)return;const i=o.getContext("2d");if(!i)return;let y=-1e3,S=-1e3,m=0,f=0;const s=[],I=()=>{const e=o.parentElement;if(e){if(o.width=e.clientWidth,o.height=e.clientHeight,m<20&&o.width>50||f<20&&o.height>50)for(const l of s)l.x=Math.random()*o.width,l.y=Math.random()*o.height;m=o.width,f=o.height}};I();for(let e=0;e<dt;e++)s.push(r(o.width,o.height));const T=e=>{const l=o.getBoundingClientRect();y=e.clientX-l.left,S=e.clientY-l.top},W=()=>{y=-1e3,S=-1e3};o.addEventListener("mousemove",T),o.addEventListener("mouseleave",W);const z=()=>{if(!(!i||!o)){i.clearRect(0,0,o.width,o.height);for(const e of s){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=o.width),e.x>o.width&&(e.x=0),e.y<0&&(e.y=o.height),e.y>o.height&&(e.y=0);const l=e.x-y,t=e.y-S,n=Math.sqrt(l*l+t*t);if(n<Q&&n>.1){const u=(Q-n)/Q;e.vx+=l/n*u*.03,e.vy+=t/n*u*.03}const a=Math.sqrt(e.vx*e.vx+e.vy*e.vy);a>1.2?(e.vx*=.95,e.vy*=.95):a<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<s.length;e++){for(let n=e+1;n<s.length;n++){const a=s[e].x-s[n].x,u=s[e].y-s[n].y;if(Math.abs(a)>k||Math.abs(u)>k)continue;const P=Math.sqrt(a*a+u*u);if(P<k){const d=1-P/k;i.beginPath(),i.moveTo(s[e].x,s[e].y),i.lineTo(s[n].x,s[n].y),i.strokeStyle=`rgba(98, 201, 255, ${d*.25})`,i.lineWidth=1,i.stroke()}}const l=s[e].x-y,t=s[e].y-S;if(Math.abs(l)<k*1.5&&Math.abs(t)<k*1.5){const n=Math.sqrt(l*l+t*t);if(n<k*1.5){const a=1-n/(k*1.5);i.beginPath(),i.moveTo(s[e].x,s[e].y),i.lineTo(y,S),i.strokeStyle=`rgba(217, 190, 111, ${a*.4})`,i.lineWidth=1.5,i.stroke()}}}for(const e of s){if(e.radius<=0)continue;i.beginPath(),i.arc(e.x,e.y,e.radius,0,Math.PI*2),i.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,i.fill();const l=e.radius*3.5;i.beginPath(),i.arc(e.x,e.y,l,0,Math.PI*2);const t=i.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,l);t.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),t.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),i.fillStyle=t,i.fill()}p=requestAnimationFrame(z)}},D=new ResizeObserver(I);o.parentElement&&D.observe(o.parentElement),p=requestAnimationFrame(z),w=()=>{cancelAnimationFrame(p),D.disconnect(),o.removeEventListener("mousemove",T),o.removeEventListener("mouseleave",W)}}),ie(()=>{w?.()}),(o,i)=>(g(),A("canvas",{ref_key:"canvasRef",ref:b,class:"enchiridion-canvas"},null,512))}}),ut=K(ct,[["__scopeId","data-v-37aa8a33"]]),ht={class:"w-100 enchiridion-nav-ui",style:{height:"100%",display:"flex","flex-direction":"column"}},pt={class:"d-flex justify-center align-center opacity-70 mr-4",style:{width:"24px"}},mt={class:"px-3 pt-2 pb-2 text-caption text-uppercase font-weight-bold header-label"},gt={class:"h-100 w-100",style:{position:"relative"}},yt={class:"reading-pane mx-auto w-100 brand-styled-content"},ft="../../../../../docs/",vt=$({__name:"enchiridion-app",setup(F){const b=Object.assign({"../../../../../docs/CHANGELOG.md":ce,"../../../../../docs/Cloudflare-Email-Routing.md":ue,"../../../../../docs/Hello-World.md":he,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":pe,"../../../../../docs/YouMeOS-Federated-Identity.md":me,"../../../../../docs/analytics_google-analytics-integration.md":ge,"../../../../../docs/authenticity_and_licensing.md":ye,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":fe,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":ve,"../../../../../docs/business/business_sephiroth_godhead_progression.md":be,"../../../../../docs/business/business_w4_protocol_economy.md":we,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":Se,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":Te,"../../../../../docs/compass/blueprints/System-Overview.md":ke,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":Pe,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":Ce,"../../../../../docs/compass/ecosystem/software_manager.md":xe,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":Ae,"../../../../../docs/compass/plugins/Bug-Net-System.md":Me,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":_e,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":Re,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":Ie,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":De,"../../../../../docs/compass/plugins/Moving-Castle-System.md":Ee,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":Oe,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":Le,"../../../../../docs/compass/plugins/magic-formula-system.md":We,"../../../../../docs/github-plugin-updater.md":ze,"../../../../../docs/moving-castle_magic-door.md":Be,"../../../../../docs/reference/Ecosystem-Architecture.md":Ge,"../../../../../docs/reference/Project-Philosophy.md":Ue,"../../../../../docs/reference/versioning.md":Fe,"../../../../../docs/spark_wizards-tower_feature-flags.md":Ne,"../../../../../docs/sparks_omegafile.md":He,"../../../../../docs/youmeos/Nomenclature-Mapping.md":Ve,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":Ye,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":je,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":qe,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":Xe,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":Qe,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Ke,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":$e,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":Je,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":Ze,"../../../../../docs/youmeos/design-system/Component-Architecture.md":en,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":nn,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":tn,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":an,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":on,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":sn,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":rn,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":ln,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":dn,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":cn,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":un,"../../../../../docs/youmeos/roadmaps/Window-Management.md":hn,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":pn,"../../../../../docs/youmeos/spark-plugs/blackbox.md":mn,"../../../../../docs/youmeos/spark-plugs/blackjack.md":gn,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":yn,"../../../../../docs/youmeos/spark-plugs/bugnet.md":fn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":vn,"../../../../../docs/youmeos/spark-plugs/calculator.md":bn,"../../../../../docs/youmeos/spark-plugs/chronos.md":wn,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":Sn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":Tn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":kn,"../../../../../docs/youmeos/spark-plugs/gaea.md":Pn,"../../../../../docs/youmeos/spark-plugs/helios.md":Cn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":xn,"../../../../../docs/youmeos/spark-plugs/jukebox.md":An,"../../../../../docs/youmeos/spark-plugs/local-produce.md":Mn,"../../../../../docs/youmeos/spark-plugs/logos.md":_n,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":Rn,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":In,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":Dn,"../../../../../docs/youmeos/spark-plugs/nexus.md":En,"../../../../../docs/youmeos/spark-plugs/noosphere.md":On,"../../../../../docs/youmeos/spark-plugs/notepad.md":Ln,"../../../../../docs/youmeos/spark-plugs/omega-source.md":Wn,"../../../../../docs/youmeos/spark-plugs/paint.md":zn,"../../../../../docs/youmeos/spark-plugs/snake.md":Bn,"../../../../../docs/youmeos/spark-plugs/social-preview.md":Gn,"../../../../../docs/youmeos/spark-plugs/solitaire.md":Un,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":Fn,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":Nn,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":Hn,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":Vn,"../../../../../docs/youmeos/spark-plugs/telescope.md":Yn,"../../../../../docs/youmeos/spark-plugs/terminal.md":jn,"../../../../../docs/youmeos/spark-plugs/tesseract.md":qn,"../../../../../docs/youmeos/spark-plugs/tourguide.md":Xn,"../../../../../docs/youmeos/spark-plugs/trenchess.md":Qn,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":Kn,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":$n,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":Jn,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":Zn,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":et,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":nt,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":tt,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":at,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":ot,"../../../../../docs/youmeos_nimbus_interaction-modes.md":it}),p=_(()=>Object.keys(b).map(t=>{const n=t.replace(ft,""),a=n.split("/"),u=a.pop()||"",P=u.replace(".md","");let d=P.split("-").map(M=>M.charAt(0).toUpperCase()+M.slice(1)).join(" "),v="03. Platform Docs",E="General";u.toLowerCase()==="hello-world.md"?(v="00. Welcome",E="Start Here"):a.length>=2&&["compass","youmeos"].includes(a[0].toLowerCase())?(v=a[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",E=a[1]):a.length>0&&(v="03. Platform Docs",E=a[0]);const C=E.replace(/[-_]/g," ").split(" ").map(M=>M.charAt(0).toUpperCase()+M.slice(1).toLowerCase()).join(" ");let B="fal fa-file-alt",N="#62c9ff";if(C.toLowerCase()==="sparks"){const G=te().apps.find(ne=>ne.id===P);G&&(B=G.icon||B,N=G.color||N,d=G.title||d)}return{path:t,relativePath:n,title:d,category:C,root:v,icon:B,color:N}}).sort((t,n)=>t.root!==n.root?t.root.localeCompare(n.root):t.category!==n.category?t.category.localeCompare(n.category):t.title.localeCompare(n.title))),w=_(()=>{const t={};p.value.forEach(a=>{t[a.root]||(t[a.root]={}),t[a.root][a.category]||(t[a.root][a.category]=[]),t[a.root][a.category].push(a)});const n={};return Object.keys(t).sort().forEach(a=>{n[a]={},Object.keys(t[a]).sort().forEach(u=>{n[a][u]=t[a][u]})}),n}),r=R(null),o=_(()=>p.value.find(t=>t.path===r.value)),i=R(null),y=_(()=>!r.value||!b[r.value]?`# Welcome to the Source

Please select a document from the rail to begin your reading.`:b[r.value]),S=t=>{r.value=t};se(r,()=>{i.value&&(i.value.scrollTop=0)},{flush:"post"});const m=R(null),f=R(null),s=R(0),I=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;let T=null;I&&(T=p.value.find(t=>t.path.toLowerCase().includes(I.toLowerCase())),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")),!r.value&&T&&(r.value=T.path,m.value=T.root,f.value=T.category,s.value=1),typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",t=>{const n=t.detail;if(n){const a=p.value.find(u=>u.path.toLowerCase().includes(n.toLowerCase()));a&&(r.value=a.path,m.value=a.root,f.value=a.category,s.value=1)}});const W=(t,n)=>{m.value=n,f.value=t,s.value=1},z=()=>{s.value=0},D=_(()=>{if(!r.value)return null;const t=p.value.findIndex(n=>n.path===r.value);return t>=0&&t<p.value.length-1?p.value[t+1]:null}),e=()=>{const t=D.value;t&&(S(t.path),(f.value!==t.category||m.value!==t.root)&&(f.value=t.category,m.value=t.root))},l=t=>{const n=t.toLowerCase();return n.includes("start here")?"fal fa-stars":n.includes("blueprints")?"fal fa-drafting-compass":n.includes("user guides")?"fal fa-map-signs":n.includes("core engine")?"fal fa-microchip":n.includes("design system")?"fal fa-swatchbook":n.includes("roadmaps")?"fal fa-road":n.includes("ecosystem")?"fal fa-planet-ringed":n.includes("plugins")||n.includes("sparks")?"fal fa-plug":n.includes("reference")?"fal fa-books":n.includes("general")?"fal fa-book-spells":"fal fa-folder"};return(t,n)=>{const a=H("x-spark-splash-action"),u=H("t-spark-splash"),P=H("u-window");return g(),O(P,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","default-width":1e3,"default-height":700,"default-nav-pinned":!0},{"nav-content":h(()=>[x("div",ht,[c(de,{modelValue:s.value,"onUpdate:modelValue":n[1]||(n[1]=d=>s.value=d),transition:"window-fade-transition","reverse-transition":"window-fade-transition",style:{height:"100%",width:"100%"}},{default:h(()=>[c(Z,{value:0,style:{height:"100%",width:"100%","overflow-y":"auto","overflow-x":"hidden"},class:"custom-scrollbar"},{default:h(()=>[c(X,{nav:"",density:"compact",class:"pb-8","bg-color":"transparent"},{default:h(()=>[c(L,{title:"The Source",class:V(["mb-1 font-weight-bold category-list-item mt-2",r.value?"opacity-80":"text-primary"]),onClick:n[0]||(n[0]=d=>r.value=null)},{prepend:h(()=>[x("div",pt,[c(ee,{icon:"fal fa-book-spells",class:V(r.value?"":"text-primary")},null,8,["class"])])]),_:1},8,["class"]),(g(!0),A(U,null,Y(w.value,(d,v)=>(g(),A(U,{key:v},[x("div",{class:V(["px-3 pt-3 pb-2 text-caption text-uppercase font-weight-bold header-label",v!==Object.keys(w.value)[0]?"mt-4":""])},j(v),3),(g(!0),A(U,null,Y(d,(E,C)=>(g(),O(L,{key:C,title:String(C),"prepend-icon":l(String(C)),"append-icon":"fal fa-chevron-right",color:"#62c9ff",class:"mb-1 opacity-80",onClick:B=>W(String(C),String(v))},null,8,["title","prepend-icon","onClick"]))),128))],64))),128))]),_:1})]),_:1}),c(Z,{value:1,style:{height:"100%",width:"100%",display:"flex","flex-direction":"column"}},{default:h(()=>[c(X,{nav:"",density:"compact",class:"flex-grow-1 custom-scrollbar","bg-color":"transparent",style:{"overflow-y":"auto","overflow-x":"hidden"}},{default:h(()=>[c(L,{"prepend-icon":"fal fa-arrow-left",title:"Back",class:"mb-2 back-btn",onClick:z}),x("div",mt,[J(j(m.value)+" ",1),n[2]||(n[2]=x("span",{class:"opacity-50 mx-1"},"/",-1)),J(" "+j(f.value),1)]),(g(!0),A(U,null,Y(m.value&&f.value&&w.value[m.value]?w.value[m.value][f.value]:[],d=>(g(),O(L,{key:d.path,title:d.title,active:r.value===d.path,class:"mb-1",color:d.color||"#62c9ff",onClick:v=>S(d.path)},{prepend:h(()=>[c(ee,{icon:d.icon||"fal fa-file-alt",color:d.color||"#62c9ff",class:"mr-3 opacity-80"},null,8,["icon","color"])]),_:2},1032,["title","active","color","onClick"]))),128))]),_:1}),D.value?(g(),O(X,{key:0,nav:"",density:"compact",class:"mt-auto px-2","bg-color":"transparent"},{default:h(()=>[c(L,{"prepend-icon":"fal fa-arrow-right",title:"Next",class:"opacity-80",onClick:e})]),_:1})):le("",!0)]),_:1})]),_:1},8,["modelValue"])])]),default:h(()=>[x("div",gt,[r.value?(g(),A("div",{key:1,ref_key:"contentScrollEl",ref:i,class:"enchiridion-content fill-height custom-scrollbar",style:re({"--brand-color":o.value?.color||"#62c9ff"})},[x("div",yt,[c(lt,{content:y.value},null,8,["content"])])],4)):(g(),O(u,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:h(()=>[c(ut)]),actions:h(()=>[c(q,{cols:"12",sm:"4"},{default:h(()=>[c(a,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),c(q,{cols:"12",sm:"4"},{default:h(()=>[c(a,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),c(q,{cols:"12",sm:"4"},{default:h(()=>[c(a,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1})}}}),Ct=K(vt,[["__scopeId","data-v-3fdcbd51"]]);export{Ct as default};
