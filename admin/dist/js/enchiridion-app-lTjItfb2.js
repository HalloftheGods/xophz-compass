...
`,ee=`# Bazaar POS Premium Upgrades
...
`,ne=`# Sovereignty Box Architecture & Value Ladder
...
`,te=`# Dirt: The Distributed Digital Mineral Economy
...
`,ae=`# YouMeOS & COMPASS: Patent Filing Strategy & Candidate Concepts
...
`,ie=`# The Godhead Progression: Thoth, Qabalah, & The 10-Layer Lineage
...
`,oe=`# YouMeOS & COMPASS: The StoryBrand Framework
...
`,re=`# The W4 Protocol: A 4D Fractal Economic Operating System
...
`,le=`# YouMeOS: The 10-Year Vision & StoryBrand Manifesto
...
`,de=`# YouMeOS Patent Analysis: Prior Art & Sequence Diagrams
...
\`\`\`
`,ce=`# YouMeOS Taxonomy & Terminology
...
`,me=`# Software Manager (Compass Suite)
...
`,ge=`# Bazaar POS (Point of Sale) System
...
`,_e=`# Magic Door — Multi-Theme Domain Mapping
...
`,We=`# YouMeOS Nomenclature & Terminology Map
...
`,ze=`# Helios Modules Documentation
...
`,Ne=`# YouMeOS: The Asynchronous Cosmos
...
`,He=`# YouMeOS: The Sovereign Node Architecture
...
`,Ze=`# Three.js Legacy Migration Guide
...
`,tn=`# WebGPU Shader Migration Plan
...
`,an=`# Window Management & Workspace Orchestration Roadmap
...
`,Kn=`# The Swiss Army Knife for Life
...
- Selection clears on mode switch or folder navigation
`,Jn=["innerHTML"],Zn=W({__name:"x-markdown",props:{content:{}},setup(x){const c=x,h=b(()=>c.content?F.parse(c.content):"");return(d,S)=>(w(),B("div",{class:"x-markdown-container",innerHTML:h.value},null,8,Jn))}}),et=E(Zn,[["__scopeId","data-v-c9651a1d"]]),nt=80,m=150,D=200,tt=W({__name:"enchiridion-canvas",setup(x){let c=!1,h=-1e3,d=-1e3;function S(n,t){const e=Math.random()>.85;return{x:Math.random()*n,y:Math.random()*t,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:e?3+Math.random()*3:1+Math.random()*1.5,baseRadius:e?3.5:1.5,hue:e?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}const a=[],T=n=>{const t=n.currentTarget;if(!t)return;const e=t.getBoundingClientRect();h=n.clientX-e.left,d=n.clientY-e.top},k=()=>{h=-1e3,d=-1e3};let g=0,f=0;const i=({canvas:n,ctx:t})=>{if(!c){for(let e=0;e<nt;e++)a.push(S(n.width,n.height));g=n.width,f=n.height,c=!0}if(g<20&&n.width>50||f<20&&n.height>50)for(const e of a)e.x=Math.random()*n.width,e.y=Math.random()*n.height;g=n.width,f=n.height,t.clearRect(0,0,n.width,n.height);for(const e of a){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=n.width),e.x>n.width&&(e.x=0),e.y<0&&(e.y=n.height),e.y>n.height&&(e.y=0);const r=e.x-h,s=e.y-d,o=Math.sqrt(r*r+s*s);if(o<D&&o>.1){const u=(D-o)/D;e.vx+=r/o*u*.03,e.vy+=s/o*u*.03}const l=Math.sqrt(e.vx*e.vx+e.vy*e.vy);l>1.2?(e.vx*=.95,e.vy*=.95):l<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<a.length;e++){for(let o=e+1;o<a.length;o++){const l=a[e].x-a[o].x,u=a[e].y-a[o].y;if(Math.abs(l)>m||Math.abs(u)>m)continue;const P=Math.sqrt(l*l+u*u);if(P<m){const C=1-P/m;t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(a[o].x,a[o].y),t.strokeStyle=`rgba(98, 201, 255, ${C*.25})`,t.lineWidth=1,t.stroke()}}const r=a[e].x-h,s=a[e].y-d;if(Math.abs(r)<m*1.5&&Math.abs(s)<m*1.5){const o=Math.sqrt(r*r+s*s);if(o<m*1.5){const l=1-o/(m*1.5);t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(h,d),t.strokeStyle=`rgba(217, 190, 111, ${l*.4})`,t.lineWidth=1.5,t.stroke()}}}for(const e of a){if(e.radius<=0)continue;t.beginPath(),t.arc(e.x,e.y,e.radius,0,Math.PI*2),t.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,t.fill();const r=e.radius*3.5;t.beginPath(),t.arc(e.x,e.y,r,0,Math.PI*2);const s=t.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,r);s.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),s.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),t.fillStyle=s,t.fill()}};return(n,t)=>{const e=M("x-canvas");return w(),O(e,{render:i,onMousemove:T,onMouseleave:k,class:"enchiridion-canvas"})}}}),at=E(tt,[["__scopeId","data-v-c8f9f032"]]),it={class:"h-100 w-100",style:{position:"relative"}},ot={class:"reading-pane mx-auto w-100 brand-styled-content"},rt="../../../../../docs/",st=W({__name:"enchiridion-app",setup(x){const c=Object.assign({"../../../../../docs/CHANGELOG.md":j,"../../../../../docs/Cloudflare-Email-Routing.md":q,"../../../../../docs/Design-Tokens.md":X,"../../../../../docs/Hello-World.md":Q,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":K,"../../../../../docs/YouMeOS-Federated-Identity.md":$,"../../../../../docs/analytics_google-analytics-integration.md":J,"../../../../../docs/authenticity_and_licensing.md":Z,"../../../../../docs/bazaar_pos_premium-upgrades.md":ee,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":ne,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":te,"../../../../../docs/business/business_patent_strategy.md":ae,"../../../../../docs/business/business_sephiroth_godhead_progression.md":ie,"../../../../../docs/business/business_storybrand_framework.md":oe,"../../../../../docs/business/business_w4_protocol_economy.md":re,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":se,"../../../../../docs/business/business_youmeos_storybrand_manifesto.md":le,"../../../../../docs/business/patent_diagrams_and_prior_art.md":de,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":ce,"../../../../../docs/compass/blueprints/System-Overview.md":he,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":ue,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":pe,"../../../../../docs/compass/ecosystem/software_manager.md":me,"../../../../../docs/compass/plugins/Bazaar-POS-System.md":ge,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":ye,"../../../../../docs/compass/plugins/Bug-Net-System.md":fe,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":ve,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":be,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":we,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":Se,"../../../../../docs/compass/plugins/Moving-Castle-System.md":Te,"../../../../../docs/compass/plugins/Performance-Widget-System.md":ke,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":Pe,"../../../../../docs/compass/plugins/Silver-Arrow-System.md":Ce,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":Ae,"../../../../../docs/compass/plugins/magic-formula-system.md":Me,"../../../../../docs/github-plugin-updater.md":xe,"../../../../../docs/moving-castle_magic-door.md":_e,"../../../../../docs/reference/Ecosystem-Architecture.md":Ie,"../../../../../docs/reference/Project-Philosophy.md":Re,"../../../../../docs/reference/versioning.md":De,"../../../../../docs/spark_wizards-tower_feature-flags.md":Oe,"../../../../../docs/sparks_omegafile.md":Ee,"../../../../../docs/youmeos/Nomenclature-Mapping.md":We,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":ze,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Le,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":Be,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":Ue,"../../../../../docs/youmeos/blueprints/Starmap-and-Federation-Blueprint.md":Ge,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":Fe,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Ne,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":He,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":Ve,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":Ye,"../../../../../docs/youmeos/design-system/Component-Architecture.md":je,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":qe,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":Xe,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":Qe,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":Ke,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":$e,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":Je,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":Ze,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":en,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":nn,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":tn,"../../../../../docs/youmeos/roadmaps/Window-Management.md":an,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":on,"../../../../../docs/youmeos/spark-plugs/blackbox.md":rn,"../../../../../docs/youmeos/spark-plugs/blackjack.md":sn,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":ln,"../../../../../docs/youmeos/spark-plugs/bugnet.md":dn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":cn,"../../../../../docs/youmeos/spark-plugs/calculator.md":hn,"../../../../../docs/youmeos/spark-plugs/chronos.md":un,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":pn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":mn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":gn,"../../../../../docs/youmeos/spark-plugs/gaea.md":yn,"../../../../../docs/youmeos/spark-plugs/helios.md":fn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":vn,"../../../../../docs/youmeos/spark-plugs/jukebox.md":bn,"../../../../../docs/youmeos/spark-plugs/local-produce.md":wn,"../../../../../docs/youmeos/spark-plugs/logos.md":Sn,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":Tn,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":kn,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":Pn,"../../../../../docs/youmeos/spark-plugs/nexus.md":Cn,"../../../../../docs/youmeos/spark-plugs/noosphere.md":An,"../../../../../docs/youmeos/spark-plugs/notepad.md":Mn,"../../../../../docs/youmeos/spark-plugs/omega-source.md":xn,"../../../../../docs/youmeos/spark-plugs/paint.md":_n,"../../../../../docs/youmeos/spark-plugs/snake.md":In,"../../../../../docs/youmeos/spark-plugs/social-preview.md":Rn,"../../../../../docs/youmeos/spark-plugs/solitaire.md":Dn,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":On,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":En,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":Wn,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":zn,"../../../../../docs/youmeos/spark-plugs/telescope.md":Ln,"../../../../../docs/youmeos/spark-plugs/terminal.md":Bn,"../../../../../docs/youmeos/spark-plugs/tesseract.md":Un,"../../../../../docs/youmeos/spark-plugs/tourguide.md":Gn,"../../../../../docs/youmeos/spark-plugs/trenchess.md":Fn,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":Nn,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":Hn,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":Vn,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":Yn,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":jn,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":qn,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":Xn,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":Qn,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":Kn,"../../../../../docs/youmeos_nimbus_interaction-modes.md":$n}),h=i=>{const n=i.toLowerCase();return n.includes("start here")?"fal fa-stars":n.includes("blueprints")?"fal fa-drafting-compass":n.includes("user guides")?"fal fa-map-signs":n.includes("core engine")?"fal fa-microchip":n.includes("design system")?"fal fa-swatchbook":n.includes("roadmaps")?"fal fa-road":n.includes("ecosystem")?"fal fa-planet-ringed":n.includes("plugins")||n.includes("sparks")?"fal fa-plug":n.includes("reference")?"fal fa-books":n.includes("general")?"fal fa-book-spells":"fal fa-folder"},d=b(()=>Object.keys(c).map(i=>{const n=i.replace(rt,""),t=n.split("/"),e=t.pop()||"",r=e.replace(".md","");let s=r.split("-").map(v=>v.charAt(0).toUpperCase()+v.slice(1)).join(" "),o="03. Platform Docs",l="General";const u=e.toLowerCase()==="hello-world.md",P=t.length>=2&&["compass","youmeos"].includes(t[0].toLowerCase());u?(o="00. Welcome",l="Start Here"):P?(o=t[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",l=t[1]):t.length>0&&(o="03. Platform Docs",l=t[0]);const C=l.replace(/[-_]/g," ").split(" ").map(v=>v.charAt(0).toUpperCase()+v.slice(1).toLowerCase()).join(" ");let _="fal fa-file-alt",I="#62c9ff";if(C.toLowerCase()==="sparks"){const A=G().apps.find(U=>U.id===r);A&&(_=A.icon||_,I=A.color||I,s=A.title||s)}return{path:i,relativePath:n,title:s,category:C,root:o,icon:_,color:I}}).sort((i,n)=>i.root!==n.root?i.root.localeCompare(n.root):i.category!==n.category?i.category.localeCompare(n.category):i.title.localeCompare(n.title))),S=b(()=>{const i={};return d.value.forEach(n=>{const t=`${n.root}/${n.category}`;i[t]||(i[t]=[]),i[t].push(n)}),Object.keys(i).sort().map(n=>{const t=i[n],e=t[0].category;return{id:n,title:e,icon:h(e),children:t.map(r=>({id:r.path,title:r.title,icon:r.icon}))}})}),a=L("splash"),T=b(()=>d.value.find(i=>i.path===a.value)),k=b(()=>a.value==="splash"||!c[a.value]?null:c[a.value]),g=L(null);N(a,()=>{g.value&&(g.value.scrollTop=0)},{flush:"post"});const f=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;if(f){const i=d.value.find(n=>n.path.toLowerCase().includes(f.toLowerCase()));i&&(a.value=i.path),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")}return typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",i=>{const n=i.detail;if(!n)return;const t=d.value.find(e=>e.path.toLowerCase().includes(n.toLowerCase()));t&&(a.value=t.path)}),(i,n)=>{const t=M("x-spark-splash-action"),e=M("t-spark-splash"),r=M("u-window");return w(),O(r,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","brand-color":"#62c9ff",width:1e3,height:700,"default-nav-pinned":"","nav-items":S.value,"active-nav":a.value,"onUpdate:activeNav":n[0]||(n[0]=s=>a.value=s)},{"app-bar-title":y(()=>[V(Y(T.value?.title||"Enchiridion"),1)]),default:y(()=>[z("div",it,[k.value?(w(),B("div",{key:1,ref_key:"contentScrollEl",ref:g,class:"enchiridion-content fill-height custom-scrollbar",style:H({"--brand-color":T.value?.color||"#62c9ff"})},[z("div",ot,[p(et,{content:k.value},null,8,["content"])])],4)):(w(),O(e,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:y(()=>[p(at)]),actions:y(()=>[p(R,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),p(R,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),p(R,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1},8,["nav-items","active-nav"])}}}),gt=E(st,[["__scopeId","data-v-3bfeb82d"]]);export{gt as default};
