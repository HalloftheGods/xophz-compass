...
`,oe=`# YouMeOS Federated Identity Architecture
...
`,ie=`# Authenticity & Licensing System
...
`,se=`# Sovereignty Box Architecture & Value Ladder
...
*   **Core Value:** Personal Identity & Standard Utility.
*   **Included Sparks:** \`Welcome-U\`, \`Passport\`, \`Neon-Notes\`, \`Notepad\`, \`Chronos\`, \`Calculator\`.
*   **Games:** \`Solitaire\`, \`Snake\`, \`Minesweeper\`, \`Blackjack\`.
*   **Gating:** Limited to 1 personal instance. Standard "YouMeOS" branding.

#### 🟫 BronzeBOX ($34.99/mo) - "The Pioneer Node"
*   **Core Value:** Enhanced Telemetry & Knowledge Management.
*   **Included Sparks:** All BlackBOX + \`Enchiridion\` (Recipes), \`Suggestion-Box\`, \`Telescope\`.
*   **Infrastructure:** Automatic Node Recovery. Priority Forge Access.
...
*   **Core Value:** Production & Performance.
*   **Included Sparks:** All BronzeBOX + \`Lemon-Aid\` (Feed Management), \`Jukebox\`, \`Paint\`.
*   **Infrastructure:** Multi-Core Synchronization. Unlimited Sparks access.
*   **Gating:** Multi-site support (up to 3 nodes). High-tier OS visual effects.

#### 🟨 GoldBOX ($129.99/mo) - "The Architect Node"
*   **Core Value:** Authority & System Design.
*   **Included Sparks:** All SilverBOX + \`Software-Manager\` (White-labeling OS layout), \`My-Compass-Suite\` (Professional tools).
*   **Infrastructure:** Dedicated Node Instance. Custom Domain Mapping.
*   **Gating:** Full control over OS layout and "Bazaar" commerce hooks.
...
#### 💠 PlatinumBOX ($Premium) - "The Sovereign Node"
*   **Core Value:** Unrestricted Compute & Connectivity.
*   **Included Sparks:** All GoldBOX + \`Sys-Monitor\`, \`Terminal\`, \`Debug-Console\`.
*   **Infrastructure:** Private Mesh Networking (Sync data between multiple universes).
*   **Gating:** Unrestricted compute resources for WebGL/WebGPU rendering.

#### ☢️ UraniumBOX ($Premium) - "The Nuclear Node"
*   **Core Value:** Raw Power & Custom Development.
*   **Included Sparks:** All PlatinumBOX + Raw API Access.
*   **Infrastructure:** Custom Kernel Extensions. High-Priority Telemetry pipelines.
*   **Gating:** Ability to inject custom Spark hooks directly into the OS.
...
#### 🔘 TitaniumBOX ($Enterprise) - "The Guardian Node"
*   **Core Value:** Indestructibility & Global Reach.
*   **Included Sparks:** All UraniumBOX + \`Local-Produce\` (Localized node management).
*   **Infrastructure:** Multi-Region Redundancy. Sovereign Vault Recovery.
*   **Gating:** 24/7 Human Relay support. If one node fails, the mini-verse migrates instantly.

#### 🔷 PalladiumBOX ($Elite) - "The Celestial Node"
*   **Core Value:** Pure Sovereignty.
*   **Included Sparks:** All TitaniumBOX + Full White-Label Federation.
*   **Infrastructure:** Quantum-Proof Security. Direct Developer Link (The "Hall" access).
*   **Gating:** Total removal of "YouMeOS" branding. Run your own branded Federation.
...
`,re=`# YouMeOS Taxonomy & Terminology
...
`,ye=`# Magic Mirror: Competitive Benchmarking & Performance Analytics
...
`,be=`# Treasure Trove & Treasure Map System
...
- Clear the transient: \`delete_transient('xophz_gh_rel_' . md5('HalloftheGods/plugin-slug'))\`
- Verify the release has a \`.zip\` asset attached

**Rate limited?**
- The 60 req/hour public limit should be fine with caching
- If you need more headroom, a GitHub token can be added to the \`wp_remote_get\` headers (1000 req/hour)
`,Se=`# The Hall of the Gods Ecosystem Architecture
...
`,ke=`# Helios Modules Documentation
...
`,Me=`# Spark Federation Protocol & Security Architecture
...
`,Re=`# YouMeOS: The Asynchronous Cosmos
...
`,Ie=`# YouMeOS: The Sovereign Node Architecture
...
`,_e=`# YouMeOS: Sovereign Identity Architecture 
...
`,ze=`# Sub-App Layout & Bazaar Routing Investigation
...
`,We=`# YouMeOS: The 4D Tesseract Visualization Plan
...
`,Ge=`# Three.js Legacy Migration Guide
...
`,Fe=`# YouMeOS Web3 Vision & Roadmap
...
`,Ve=`# WebGPU Shader Migration Plan
...
`,He=`# Window Management & Workspace Orchestration Roadmap
...
`,je=`# YouMeOS Decentralization & Local-First Architecture Roadmap
...
`,Ye=`# Getting Started with YouMeOS
...
`,qe=["innerHTML"],Xe=H({__name:"x-markdown",props:{content:{}},setup(z){const w=z,h=_(()=>w.content?$.parse(w.content):"");return(P,r)=>(y(),x("div",{class:"x-markdown-container",innerHTML:h.value},null,8,qe))}}),$e=j(Xe,[["__scopeId","data-v-c9651a1d"]]),Ke=80,k=150,V=200,Je=H({__name:"enchiridion-canvas",setup(z){const w=M(null);let h=0,P=null;function r(o,i){const m=Math.random()>.85;return{x:Math.random()*o,y:Math.random()*i,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:m?3+Math.random()*3:1+Math.random()*1.5,baseRadius:m?3.5:1.5,hue:m?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}return K(()=>{const o=w.value;if(!o)return;const i=o.getContext("2d");if(!i)return;let m=-1e3,p=-1e3,f=0,S=0;const s=[],T=()=>{const e=o.parentElement;if(e){if(o.width=e.clientWidth,o.height=e.clientHeight,f<20&&o.width>50||S<20&&o.height>50)for(const n of s)n.x=Math.random()*o.width,n.y=Math.random()*o.height;f=o.width,S=o.height}};T();for(let e=0;e<Ke;e++)s.push(r(o.width,o.height));const D=e=>{const n=o.getBoundingClientRect();m=e.clientX-n.left,p=e.clientY-n.top},E=()=>{m=-1e3,p=-1e3};o.addEventListener("mousemove",D),o.addEventListener("mouseleave",E);const A=()=>{if(!(!i||!o)){i.clearRect(0,0,o.width,o.height);for(const e of s){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=o.width),e.x>o.width&&(e.x=0),e.y<0&&(e.y=o.height),e.y>o.height&&(e.y=0);const n=e.x-m,t=e.y-p,a=Math.sqrt(n*n+t*t);if(a<V&&a>.1){const v=(V-a)/V;e.vx+=n/a*v*.03,e.vy+=t/a*v*.03}const l=Math.sqrt(e.vx*e.vx+e.vy*e.vy);l>1.2?(e.vx*=.95,e.vy*=.95):l<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<s.length;e++){for(let a=e+1;a<s.length;a++){const l=s[e].x-s[a].x,v=s[e].y-s[a].y;if(Math.abs(l)>k||Math.abs(v)>k)continue;const d=Math.sqrt(l*l+v*v);if(d<k){const g=1-d/k;i.beginPath(),i.moveTo(s[e].x,s[e].y),i.lineTo(s[a].x,s[a].y),i.strokeStyle=`rgba(98, 201, 255, ${g*.25})`,i.lineWidth=1,i.stroke()}}const n=s[e].x-m,t=s[e].y-p;if(Math.abs(n)<k*1.5&&Math.abs(t)<k*1.5){const a=Math.sqrt(n*n+t*t);if(a<k*1.5){const l=1-a/(k*1.5);i.beginPath(),i.moveTo(s[e].x,s[e].y),i.lineTo(m,p),i.strokeStyle=`rgba(217, 190, 111, ${l*.4})`,i.lineWidth=1.5,i.stroke()}}}for(const e of s){if(e.radius<=0)continue;i.beginPath(),i.arc(e.x,e.y,e.radius,0,Math.PI*2),i.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,i.fill();const n=e.radius*3.5;i.beginPath(),i.arc(e.x,e.y,n,0,Math.PI*2);const t=i.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,n);t.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),t.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),i.fillStyle=t,i.fill()}h=requestAnimationFrame(A)}},L=new ResizeObserver(T);o.parentElement&&L.observe(o.parentElement),h=requestAnimationFrame(A),P=()=>{cancelAnimationFrame(h),L.disconnect(),o.removeEventListener("mousemove",D),o.removeEventListener("mouseleave",E)}}),J(()=>{P?.()}),(o,i)=>(y(),x("canvas",{ref_key:"canvasRef",ref:w,class:"enchiridion-canvas"},null,512))}}),Ze=j(Je,[["__scopeId","data-v-37aa8a33"]]),Qe={class:"w-100 enchiridion-nav-ui",style:{height:"100%",display:"flex","flex-direction":"column"}},en={class:"d-flex justify-center align-center opacity-70 mr-4",style:{width:"24px"}},nn={class:"px-3 pt-2 pb-2 text-caption text-uppercase font-weight-bold header-label"},tn={class:"h-100 w-100",style:{position:"relative"}},an={class:"reading-pane mx-auto w-100"},on="../../../../../docs/",sn=H({__name:"enchiridion-app",setup(z){const w=Object.assign({"../../../../../docs/CHANGELOG.md":te,"../../../../../docs/Hello-World.md":ae,"../../../../../docs/YouMeOS-Federated-Identity.md":oe,"../../../../../docs/authenticity_and_licensing.md":ie,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":se,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":re,"../../../../../docs/compass/blueprints/System-Overview.md":le,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":de,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":ce,"../../../../../docs/compass/ecosystem/software_manager.md":pe,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":ue,"../../../../../docs/compass/plugins/Bug-Net-System.md":he,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":me,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":ge,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":ye,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":fe,"../../../../../docs/compass/plugins/Moving-Castle-System.md":ve,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":be,"../../../../../docs/github-plugin-updater.md":we,"../../../../../docs/reference/Ecosystem-Architecture.md":Se,"../../../../../docs/reference/Project-Philosophy.md":Pe,"../../../../../docs/reference/versioning.md":Te,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":ke,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Ce,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":xe,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":Me,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":Ae,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Re,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":Ie,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":_e,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":De,"../../../../../docs/youmeos/design-system/Component-Architecture.md":Ee,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":Le,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":Oe,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":ze,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":Ue,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":Be,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":We,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":Ge,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":Fe,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":Ne,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":Ve,"../../../../../docs/youmeos/roadmaps/Window-Management.md":He,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":je,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":Ye}),h=_(()=>Object.keys(w).map(n=>{const t=n.replace(on,""),a=t.split("/"),l=a.pop()||"",v=l.replace(".md","").split("-").map(b=>b.charAt(0).toUpperCase()+b.slice(1)).join(" ");let d="03. Platform Docs",g="General";l.toLowerCase()==="hello-world.md"?(d="00. Welcome",g="Start Here"):a.length>=2&&["compass","youmeos"].includes(a[0].toLowerCase())?(d=a[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",g=a[1]):a.length>0&&(d="03. Platform Docs",g=a[0]);const Y=g.replace(/[-_]/g," ").split(" ").map(b=>b.charAt(0).toUpperCase()+b.slice(1).toLowerCase()).join(" ");return{path:n,relativePath:t,title:v,category:Y,root:d}}).sort((n,t)=>n.root!==t.root?n.root.localeCompare(t.root):n.category!==t.category?n.category.localeCompare(t.category):n.title.localeCompare(t.title))),P=_(()=>{const n={};h.value.forEach(a=>{n[a.root]||(n[a.root]={}),n[a.root][a.category]||(n[a.root][a.category]=[]),n[a.root][a.category].push(a)});const t={};return Object.keys(n).sort().forEach(a=>{t[a]={},Object.keys(n[a]).sort().forEach(l=>{t[a][l]=n[a][l]})}),t}),r=M(null),o=M(null),i=_(()=>!r.value||!w[r.value]?`# Welcome to the Source

Please select a document from the rail to begin your reading.`:w[r.value]),m=n=>{r.value=n};Z(r,()=>{o.value&&(o.value.scrollTop=0)},{flush:"post"});const p=M(null),f=M(null),S=M(0),s=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;let T=null;s&&(T=h.value.find(n=>n.path.toLowerCase().includes(s.toLowerCase())),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")),!r.value&&T&&(r.value=T.path,p.value=T.root,f.value=T.category,S.value=1),typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",n=>{const t=n.detail;if(t){const a=h.value.find(l=>l.path.toLowerCase().includes(t.toLowerCase()));a&&(r.value=a.path,p.value=a.root,f.value=a.category,S.value=1)}});const D=(n,t)=>{p.value=t,f.value=n,S.value=1},E=()=>{S.value=0},A=_(()=>{if(!r.value)return null;const n=h.value.findIndex(t=>t.path===r.value);return n>=0&&n<h.value.length-1?h.value[n+1]:null}),L=()=>{const n=A.value;n&&(m(n.path),(f.value!==n.category||p.value!==n.root)&&(f.value=n.category,p.value=n.root))},e=n=>{const t=n.toLowerCase();return t.includes("start here")?"fal fa-stars":t.includes("blueprints")?"fal fa-drafting-compass":t.includes("user guides")?"fal fa-map-signs":t.includes("core engine")?"fal fa-microchip":t.includes("design system")?"fal fa-swatchbook":t.includes("roadmaps")?"fal fa-road":t.includes("ecosystem")?"fal fa-planet-ringed":t.includes("plugins")?"fal fa-plug":t.includes("reference")?"fal fa-books":t.includes("general")?"fal fa-book-spells":"fal fa-folder"};return(n,t)=>{const a=U("x-spark-splash-action"),l=U("t-spark-splash"),v=U("u-window");return y(),R(v,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","default-width":1e3,"default-height":700,"default-nav-pinned":!0},{"nav-content":u(()=>[C("div",Qe,[c(ee,{modelValue:S.value,"onUpdate:modelValue":t[1]||(t[1]=d=>S.value=d),transition:"window-fade-transition","reverse-transition":"window-fade-transition",style:{height:"100%",width:"100%"}},{default:u(()=>[c(X,{value:0,style:{height:"100%",width:"100%","overflow-y":"auto","overflow-x":"hidden"},class:"custom-scrollbar"},{default:u(()=>[c(N,{nav:"",density:"compact",class:"pb-8","bg-color":"transparent"},{default:u(()=>[c(I,{title:"The Source",class:B(["mb-1 font-weight-bold category-list-item mt-2",r.value?"opacity-80":"text-primary"]),onClick:t[0]||(t[0]=d=>r.value=null)},{prepend:u(()=>[C("div",en,[c(ne,{icon:"fal fa-book-spells",class:B(r.value?"":"text-primary")},null,8,["class"])])]),_:1},8,["class"]),(y(!0),x(O,null,W(P.value,(d,g)=>(y(),x(O,{key:g},[C("div",{class:B(["px-3 pt-3 pb-2 text-caption text-uppercase font-weight-bold header-label",g!==Object.keys(P.value)[0]?"mt-4":""])},G(g),3),(y(!0),x(O,null,W(d,(Y,b)=>(y(),R(I,{key:b,title:String(b),"prepend-icon":e(String(b)),"append-icon":"fal fa-chevron-right",color:"#62c9ff",class:"mb-1 opacity-80",onClick:rn=>D(String(b),String(g))},null,8,["title","prepend-icon","onClick"]))),128))],64))),128))]),_:1})]),_:1}),c(X,{value:1,style:{height:"100%",width:"100%",display:"flex","flex-direction":"column"}},{default:u(()=>[c(N,{nav:"",density:"compact",class:"flex-grow-1 custom-scrollbar","bg-color":"transparent",style:{"overflow-y":"auto","overflow-x":"hidden"}},{default:u(()=>[c(I,{"prepend-icon":"fal fa-arrow-left",title:"Back",class:"mb-2 back-btn",onClick:E}),C("div",nn,[q(G(p.value)+" ",1),t[2]||(t[2]=C("span",{class:"opacity-50 mx-1"},"/",-1)),q(" "+G(f.value),1)]),(y(!0),x(O,null,W(p.value&&f.value&&P.value[p.value]?P.value[p.value][f.value]:[],d=>(y(),R(I,{key:d.path,title:d.title,"prepend-icon":"fal fa-file-alt",active:r.value===d.path,class:"mb-1",color:"#62c9ff",onClick:g=>m(d.path)},null,8,["title","active","onClick"]))),128))]),_:1}),A.value?(y(),R(N,{key:0,nav:"",density:"compact",class:"mt-auto px-2","bg-color":"transparent"},{default:u(()=>[c(I,{"prepend-icon":"fal fa-arrow-right",title:"Next",class:"opacity-80",onClick:L})]),_:1})):Q("",!0)]),_:1})]),_:1},8,["modelValue"])])]),default:u(()=>[C("div",tn,[r.value?(y(),x("div",{key:1,ref_key:"contentScrollEl",ref:o,class:"enchiridion-content fill-height custom-scrollbar"},[C("div",an,[c($e,{content:i.value},null,8,["content"])])],512)):(y(),R(l,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:u(()=>[c(Ze)]),actions:u(()=>[c(F,{cols:"12",sm:"4"},{default:u(()=>[c(a,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),c(F,{cols:"12",sm:"4"},{default:u(()=>[c(a,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),c(F,{cols:"12",sm:"4"},{default:u(()=>[c(a,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1})}}}),un=j(sn,[["__scopeId","data-v-085807fe"]]);export{un as default};
