...
`,ue=`# The W4 Protocol: Fractal Architecture & Civilizational Infrastructure
...
`,he=`# YouMeOS Federated Identity Architecture
...
`,ge=`# Sovereignty Box Architecture & Value Ladder
...
`,ye=`# Dirt: The Distributed Digital Mineral Economy
...
`,fe=`# The Godhead Progression: Thoth, Qabalah, & The 10-Layer Lineage
...
`,ve=`# The W4 Protocol: A 4D Fractal Economic Operating System
...
`,be=`# YouMeOS: The Decentralized Operating System of the Internet
...
`,Pe=`# Software Manager (Compass Suite)
...
`,_e=`# Magic Mirror: Competitive Benchmarking & Performance Analytics
...
`,it=`# The Swiss Army Knife for Life
...
- Selection clears on mode switch or folder navigation
`,st=["innerHTML"],rt=$({__name:"x-markdown",props:{content:{}},setup(F){const S=F,u=R(()=>S.content?ae.parse(S.content):"");return(f,r)=>(y(),_("div",{class:"x-markdown-container",innerHTML:u.value},null,8,st))}}),lt=K(rt,[["__scopeId","data-v-c9651a1d"]]),dt=80,P=150,Q=200,ct=$({__name:"enchiridion-canvas",setup(F){let S=!1,u=-1e3,f=-1e3;function r(o,a){const e=Math.random()>.85;return{x:Math.random()*o,y:Math.random()*a,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:e?3+Math.random()*3:1+Math.random()*1.5,baseRadius:e?3.5:1.5,hue:e?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}const s=[],D=o=>{const a=o.currentTarget;if(!a)return;const e=a.getBoundingClientRect();u=o.clientX-e.left,f=o.clientY-e.top},N=()=>{u=-1e3,f=-1e3};let M=0,p=0;const v=({canvas:o,ctx:a})=>{if(!S){for(let e=0;e<dt;e++)s.push(r(o.width,o.height));M=o.width,p=o.height,S=!0}if(M<20&&o.width>50||p<20&&o.height>50)for(const e of s)e.x=Math.random()*o.width,e.y=Math.random()*o.height;M=o.width,p=o.height,a.clearRect(0,0,o.width,o.height);for(const e of s){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=o.width),e.x>o.width&&(e.x=0),e.y<0&&(e.y=o.height),e.y>o.height&&(e.y=0);const g=e.x-u,m=e.y-f,l=Math.sqrt(g*g+m*m);if(l<Q&&l>.1){const k=(Q-l)/Q;e.vx+=g/l*k*.03,e.vy+=m/l*k*.03}const b=Math.sqrt(e.vx*e.vx+e.vy*e.vy);b>1.2?(e.vx*=.95,e.vy*=.95):b<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<s.length;e++){for(let l=e+1;l<s.length;l++){const b=s[e].x-s[l].x,k=s[e].y-s[l].y;if(Math.abs(b)>P||Math.abs(k)>P)continue;const n=Math.sqrt(b*b+k*k);if(n<P){const t=1-n/P;a.beginPath(),a.moveTo(s[e].x,s[e].y),a.lineTo(s[l].x,s[l].y),a.strokeStyle=`rgba(98, 201, 255, ${t*.25})`,a.lineWidth=1,a.stroke()}}const g=s[e].x-u,m=s[e].y-f;if(Math.abs(g)<P*1.5&&Math.abs(m)<P*1.5){const l=Math.sqrt(g*g+m*m);if(l<P*1.5){const b=1-l/(P*1.5);a.beginPath(),a.moveTo(s[e].x,s[e].y),a.lineTo(u,f),a.strokeStyle=`rgba(217, 190, 111, ${b*.4})`,a.lineWidth=1.5,a.stroke()}}}for(const e of s){if(e.radius<=0)continue;a.beginPath(),a.arc(e.x,e.y,e.radius,0,Math.PI*2),a.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,a.fill();const g=e.radius*3.5;a.beginPath(),a.arc(e.x,e.y,g,0,Math.PI*2);const m=a.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,g);m.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),m.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),a.fillStyle=m,a.fill()}};return(o,a)=>{const e=G("x-canvas");return y(),I(e,{render:v,onMousemove:D,onMouseleave:N,class:"enchiridion-canvas"})}}}),ut=K(ct,[["__scopeId","data-v-c8f9f032"]]),ht={class:"w-100 enchiridion-nav-ui",style:{height:"100%",display:"flex","flex-direction":"column"}},pt={class:"d-flex justify-center align-center opacity-70 mr-4",style:{width:"24px"}},mt={class:"px-3 pt-2 pb-2 text-caption text-uppercase font-weight-bold header-label"},gt={class:"h-100 w-100",style:{position:"relative"}},yt={class:"reading-pane mx-auto w-100 brand-styled-content"},ft="../../../../../docs/",vt=$({__name:"enchiridion-app",setup(F){const S=Object.assign({"../../../../../docs/CHANGELOG.md":le,"../../../../../docs/Cloudflare-Email-Routing.md":de,"../../../../../docs/Hello-World.md":ce,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":ue,"../../../../../docs/YouMeOS-Federated-Identity.md":he,"../../../../../docs/analytics_google-analytics-integration.md":pe,"../../../../../docs/authenticity_and_licensing.md":me,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":ge,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":ye,"../../../../../docs/business/business_sephiroth_godhead_progression.md":fe,"../../../../../docs/business/business_w4_protocol_economy.md":ve,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":be,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":we,"../../../../../docs/compass/blueprints/System-Overview.md":Se,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":Te,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":ke,"../../../../../docs/compass/ecosystem/software_manager.md":Pe,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":Ce,"../../../../../docs/compass/plugins/Bug-Net-System.md":Ae,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":Me,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":xe,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":_e,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":Re,"../../../../../docs/compass/plugins/Moving-Castle-System.md":Ie,"../../../../../docs/compass/plugins/Performance-Widget-System.md":De,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":Oe,"../../../../../docs/compass/plugins/Silver-Arrow-System.md":Ee,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":Le,"../../../../../docs/compass/plugins/magic-formula-system.md":We,"../../../../../docs/github-plugin-updater.md":ze,"../../../../../docs/moving-castle_magic-door.md":Be,"../../../../../docs/reference/Ecosystem-Architecture.md":Ue,"../../../../../docs/reference/Project-Philosophy.md":Ge,"../../../../../docs/reference/versioning.md":Fe,"../../../../../docs/spark_wizards-tower_feature-flags.md":Ne,"../../../../../docs/sparks_omegafile.md":He,"../../../../../docs/youmeos/Nomenclature-Mapping.md":Ve,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":Ye,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":je,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":qe,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":Xe,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":Qe,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Ke,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":$e,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":Je,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":Ze,"../../../../../docs/youmeos/design-system/Component-Architecture.md":en,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":nn,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":tn,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":an,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":on,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":sn,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":rn,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":ln,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":dn,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":cn,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":un,"../../../../../docs/youmeos/roadmaps/Window-Management.md":hn,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":pn,"../../../../../docs/youmeos/spark-plugs/blackbox.md":mn,"../../../../../docs/youmeos/spark-plugs/blackjack.md":gn,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":yn,"../../../../../docs/youmeos/spark-plugs/bugnet.md":fn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":vn,"../../../../../docs/youmeos/spark-plugs/calculator.md":bn,"../../../../../docs/youmeos/spark-plugs/chronos.md":wn,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":Sn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":Tn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":kn,"../../../../../docs/youmeos/spark-plugs/gaea.md":Pn,"../../../../../docs/youmeos/spark-plugs/helios.md":Cn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":An,"../../../../../docs/youmeos/spark-plugs/jukebox.md":Mn,"../../../../../docs/youmeos/spark-plugs/local-produce.md":xn,"../../../../../docs/youmeos/spark-plugs/logos.md":_n,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":Rn,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":In,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":Dn,"../../../../../docs/youmeos/spark-plugs/nexus.md":On,"../../../../../docs/youmeos/spark-plugs/noosphere.md":En,"../../../../../docs/youmeos/spark-plugs/notepad.md":Ln,"../../../../../docs/youmeos/spark-plugs/omega-source.md":Wn,"../../../../../docs/youmeos/spark-plugs/paint.md":zn,"../../../../../docs/youmeos/spark-plugs/snake.md":Bn,"../../../../../docs/youmeos/spark-plugs/social-preview.md":Un,"../../../../../docs/youmeos/spark-plugs/solitaire.md":Gn,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":Fn,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":Nn,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":Hn,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":Vn,"../../../../../docs/youmeos/spark-plugs/telescope.md":Yn,"../../../../../docs/youmeos/spark-plugs/terminal.md":jn,"../../../../../docs/youmeos/spark-plugs/tesseract.md":qn,"../../../../../docs/youmeos/spark-plugs/tourguide.md":Xn,"../../../../../docs/youmeos/spark-plugs/trenchess.md":Qn,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":Kn,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":$n,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":Jn,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":Zn,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":et,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":nt,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":tt,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":at,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":it,"../../../../../docs/youmeos_nimbus_interaction-modes.md":ot}),u=R(()=>Object.keys(S).map(n=>{const t=n.replace(ft,""),i=t.split("/"),T=i.pop()||"",W=T.replace(".md","");let c=W.split("-").map(x=>x.charAt(0).toUpperCase()+x.slice(1)).join(" "),w="03. Platform Docs",O="General";T.toLowerCase()==="hello-world.md"?(w="00. Welcome",O="Start Here"):i.length>=2&&["compass","youmeos"].includes(i[0].toLowerCase())?(w=i[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",O=i[1]):i.length>0&&(w="03. Platform Docs",O=i[0]);const C=O.replace(/[-_]/g," ").split(" ").map(x=>x.charAt(0).toUpperCase()+x.slice(1).toLowerCase()).join(" ");let z="fal fa-file-alt",H="#62c9ff";if(C.toLowerCase()==="sparks"){const B=te().apps.find(ne=>ne.id===W);B&&(z=B.icon||z,H=B.color||H,c=B.title||c)}return{path:n,relativePath:t,title:c,category:C,root:w,icon:z,color:H}}).sort((n,t)=>n.root!==t.root?n.root.localeCompare(t.root):n.category!==t.category?n.category.localeCompare(t.category):n.title.localeCompare(t.title))),f=R(()=>{const n={};u.value.forEach(i=>{n[i.root]||(n[i.root]={}),n[i.root][i.category]||(n[i.root][i.category]=[]),n[i.root][i.category].push(i)});const t={};return Object.keys(n).sort().forEach(i=>{t[i]={},Object.keys(n[i]).sort().forEach(T=>{t[i][T]=n[i][T]})}),t}),r=E(null),s=R(()=>u.value.find(n=>n.path===r.value)),D=E(null),N=R(()=>!r.value||!S[r.value]?`# Welcome to the Source

Please select a document from the rail to begin your reading.`:S[r.value]),M=n=>{r.value=n};ie(r,()=>{D.value&&(D.value.scrollTop=0)},{flush:"post"});const p=E(null),v=E(null),o=E(0),a=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;let e=null;a&&(e=u.value.find(n=>n.path.toLowerCase().includes(a.toLowerCase())),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")),!r.value&&e&&(r.value=e.path,p.value=e.root,v.value=e.category,o.value=1),typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",n=>{const t=n.detail;if(t){const i=u.value.find(T=>T.path.toLowerCase().includes(t.toLowerCase()));i&&(r.value=i.path,p.value=i.root,v.value=i.category,o.value=1)}});const g=(n,t)=>{p.value=t,v.value=n,o.value=1},m=()=>{o.value=0},l=R(()=>{if(!r.value)return null;const n=u.value.findIndex(t=>t.path===r.value);return n>=0&&n<u.value.length-1?u.value[n+1]:null}),b=()=>{const n=l.value;n&&(M(n.path),(v.value!==n.category||p.value!==n.root)&&(v.value=n.category,p.value=n.root))},k=n=>{const t=n.toLowerCase();return t.includes("start here")?"fal fa-stars":t.includes("blueprints")?"fal fa-drafting-compass":t.includes("user guides")?"fal fa-map-signs":t.includes("core engine")?"fal fa-microchip":t.includes("design system")?"fal fa-swatchbook":t.includes("roadmaps")?"fal fa-road":t.includes("ecosystem")?"fal fa-planet-ringed":t.includes("plugins")||t.includes("sparks")?"fal fa-plug":t.includes("reference")?"fal fa-books":t.includes("general")?"fal fa-book-spells":"fal fa-folder"};return(n,t)=>{const i=G("x-spark-splash-action"),T=G("t-spark-splash"),W=G("u-window");return y(),I(W,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","default-width":1e3,"default-height":700,"default-nav-pinned":!0},{"nav-content":h(()=>[A("div",ht,[d(re,{modelValue:o.value,"onUpdate:modelValue":t[1]||(t[1]=c=>o.value=c),transition:"window-fade-transition","reverse-transition":"window-fade-transition",style:{height:"100%",width:"100%"}},{default:h(()=>[d(Z,{value:0,style:{height:"100%",width:"100%","overflow-y":"auto","overflow-x":"hidden"},class:"custom-scrollbar"},{default:h(()=>[d(X,{nav:"",density:"compact",class:"pb-8","bg-color":"transparent"},{default:h(()=>[d(L,{title:"The Source",class:V(["mb-1 font-weight-bold category-list-item mt-2",r.value?"opacity-80":"text-primary"]),onClick:t[0]||(t[0]=c=>r.value=null)},{prepend:h(()=>[A("div",pt,[d(ee,{icon:"fal fa-book-spells",class:V(r.value?"":"text-primary")},null,8,["class"])])]),_:1},8,["class"]),(y(!0),_(U,null,Y(f.value,(c,w)=>(y(),_(U,{key:w},[A("div",{class:V(["px-3 pt-3 pb-2 text-caption text-uppercase font-weight-bold header-label",w!==Object.keys(f.value)[0]?"mt-4":""])},j(w),3),(y(!0),_(U,null,Y(c,(O,C)=>(y(),I(L,{key:C,title:String(C),"prepend-icon":k(String(C)),"append-icon":"fal fa-chevron-right",color:"#62c9ff",class:"mb-1 opacity-80",onClick:z=>g(String(C),String(w))},null,8,["title","prepend-icon","onClick"]))),128))],64))),128))]),_:1})]),_:1}),d(Z,{value:1,style:{height:"100%",width:"100%",display:"flex","flex-direction":"column"}},{default:h(()=>[d(X,{nav:"",density:"compact",class:"flex-grow-1 custom-scrollbar","bg-color":"transparent",style:{"overflow-y":"auto","overflow-x":"hidden"}},{default:h(()=>[d(L,{"prepend-icon":"fal fa-arrow-left",title:"Back",class:"mb-2 back-btn",onClick:m}),A("div",mt,[J(j(p.value)+" ",1),t[2]||(t[2]=A("span",{class:"opacity-50 mx-1"},"/",-1)),J(" "+j(v.value),1)]),(y(!0),_(U,null,Y(p.value&&v.value&&f.value[p.value]?f.value[p.value][v.value]:[],c=>(y(),I(L,{key:c.path,title:c.title,active:r.value===c.path,class:"mb-1",color:c.color||"#62c9ff",onClick:w=>M(c.path)},{prepend:h(()=>[d(ee,{icon:c.icon||"fal fa-file-alt",color:c.color||"#62c9ff",class:"mr-3 opacity-80"},null,8,["icon","color"])]),_:2},1032,["title","active","color","onClick"]))),128))]),_:1}),l.value?(y(),I(X,{key:0,nav:"",density:"compact",class:"mt-auto px-2","bg-color":"transparent"},{default:h(()=>[d(L,{"prepend-icon":"fal fa-arrow-right",title:"Next",class:"opacity-80",onClick:b})]),_:1})):se("",!0)]),_:1})]),_:1},8,["modelValue"])])]),default:h(()=>[A("div",gt,[r.value?(y(),_("div",{key:1,ref_key:"contentScrollEl",ref:D,class:"enchiridion-content fill-height custom-scrollbar",style:oe({"--brand-color":s.value?.color||"#62c9ff"})},[A("div",yt,[d(lt,{content:N.value},null,8,["content"])])],4)):(y(),I(T,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:h(()=>[d(ut)]),actions:h(()=>[d(q,{cols:"12",sm:"4"},{default:h(()=>[d(i,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),d(q,{cols:"12",sm:"4"},{default:h(()=>[d(i,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),d(q,{cols:"12",sm:"4"},{default:h(()=>[d(i,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1})}}}),Ct=K(vt,[["__scopeId","data-v-3fdcbd51"]]);export{Ct as default};
