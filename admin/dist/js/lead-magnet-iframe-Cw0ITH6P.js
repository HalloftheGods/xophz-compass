import{f as b,co as c,e as h,d as g,V as f,ca as w,cd as x,l as v,m as k}from"./vendor-C_wzOzOP.js";import{a as y}from"./index-BVC0i8Oj.js";import"./vendor-core-jhTGTKns.js";import"./vendor-vuetify-BC38IVfl.js";import"./vendor-three-DbgnMstn.js";import"./vendor-echarts-DKcEROtP.js";const B=b({name:"LeadMagnetIframe",setup(){const n=c(),r=h(null);return{wpPage:g(()=>n.meta.wpPage||"hustle"),iframeRef:r,injectStyles:()=>{const a=r.value?.$el||r.value;if(a)try{const t=a.contentDocument||a.contentWindow?.document;if(!t)return;t.documentElement.classList.add("compass-theme-transparent","compass-embed-mode"),t.body.classList.add("compass-theme-transparent","compass-embed-mode");const o=()=>{if(!a||!t.body)return;const p=t.querySelector(".sui-wrap, .hustle-ui"),d=t.getElementById("wpwrap");let i=t.documentElement.scrollHeight;p&&(i=Math.max(i,p.scrollHeight+50)),d&&(i=Math.max(i,d.scrollHeight+50)),a.style.height=`${i}px`};setTimeout(o,100),setTimeout(o,500),setTimeout(o,1500);const s=new ResizeObserver(o);s.observe(t.body);const u=t.querySelector(".sui-wrap, .hustle-ui");u&&s.observe(u),new MutationObserver(o).observe(t.body,{childList:!0,subtree:!0});let e=t.getElementById("compass-sui-overrides");e||(e=t.createElement("style"),e.id="compass-sui-overrides",e.innerHTML=`
            ...
            .sui-modal, .sui-modal.sui-active, .sui-dialog, .sui-modal-content, .sui-modal-slide, .sui-modal-slide.sui-active, .hustle-modal {
            ...
            .sui-modal, .sui-dialog, .hustle-modal {
            ...
            .sui-modal .sui-box, .sui-dialog .sui-box, .hustle-modal .sui-box {
          ...
          `,t.head.appendChild(e))}catch(t){console.warn("[Lead Magnet] Could not inject iframe styles",t)}}}}}),M={class:"lead-magnet-iframe-container position-relative"};function _(n,r,m,l,a,t){const o=f("x-iframe");return w(),x("div",M,[v(o,{ref:"iframeRef",name:"compass-sub-app",class:"hustle-iframe",src:`/wp-admin/admin.php?page=${n.wpPage}&compass_iframe=1&embed=1&theme=transparent`,onLoad:n.injectStyles},null,8,["src","onLoad"]),r[0]||(r[0]=k("div",{class:"browser-overlay pointer-events-none"},null,-1))])}const $=y(B,[["render",_],["__scopeId","data-v-e1505630"]]);export{$ as default};
