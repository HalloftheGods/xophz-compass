import{f as i,ci as p,e as d,d as c,V as m,c5 as u,c6 as l,l as b,m as w}from"./vendor-DmYAHk75.js";import{a as f}from"./index-CbcO5v7C.js";import"./vendor-core-DQF5ls93.js";import"./vendor-vuetify-B3qgTdwP.js";import"./vendor-echarts-C11G8drz.js";const g=i({name:"MagicWandIframe",setup(){const t=p(),r=d(null);return{wpPage:c(()=>t.meta.wpPage||"wds_wizard"),iframeRef:r,injectStyles:()=>{if(r.value)try{const a=r.value.contentDocument||r.value.contentWindow?.document;if(!a)return;a.documentElement.classList.add("compass-theme-transparent","compass-embed-mode"),a.body.classList.add("compass-theme-transparent","compass-embed-mode");let e=a.getElementById("compass-sui-overrides");e||(e=a.createElement("style"),e.id="compass-sui-overrides",e.innerHTML=`
          ...
          `,a.head.appendChild(e))}catch(a){console.warn("[Magic Wand] Could not inject iframe styles",a)}}}}}),x={class:"magic-wand-iframe-container position-relative"};function h(t,r,o,s,a,e){const n=m("x-iframe");return u(),l("div",x,[b(n,{ref:"iframeRef",name:"compass-sub-app",class:"seo-iframe",src:`/wp-admin/admin.php?page=${t.wpPage}&compass_iframe=1&embed=1&theme=transparent`,onLoad:t.injectStyles},null,8,["src","onLoad"]),r[0]||(r[0]=w("div",{class:"browser-overlay pointer-events-none"},null,-1))])}const S=f(g,[["render",h],["__scopeId","data-v-1390a9a5"]]);export{S as default};
