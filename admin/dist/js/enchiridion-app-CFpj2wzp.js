import{a as E,e as U}from"./index-BbGbVsY7.js";import{f as z,cc as w,cf as L,d as b,d5 as G,V as x,cd as D,x as N,ch as y,m as W,l as u,y as H,Z as V,Q as Y,e as B}from"./vendor-1zoF_Idf.js";import{M as R}from"./vendor-vuetify-IcK50R0K.js";import"./vendor-core-C1HcRbWD.js";import"./vendor-three-DbgnMstn.js";import"./vendor-echarts-DW-Erf2S.js";const j=`# Bomb Bag System (Email Marketing & CRM)
...
`,$=`# Project Philosophy: YouMeOS Design & UX Principles
...
`,pe=`# YouMeOS: The 10-Year Vision & StoryBrand Manifesto
...
`,ue=`# Ecosystem Email Marketing Strategy & Drip Campaigns
...
`,Oe=`# Treasure Trove & Treasure Map System
...
`,Be=`# The Hall of the Gods Ecosystem Architecture
...
- Selection clears on mode switch or folder navigation
`,it=["innerHTML"],st=z({__name:"x-markdown",props:{content:{}},setup(M){const c=M,h=b(()=>c.content?G.parse(c.content):"");return(d,S)=>(w(),L("div",{class:"x-markdown-container",innerHTML:h.value},null,8,it))}}),rt=E(st,[["__scopeId","data-v-c9651a1d"]]),lt=80,m=150,O=200,dt=z({__name:"enchiridion-canvas",setup(M){let c=!1,h=-1e3,d=-1e3;function S(n,t){const e=Math.random()>.85;return{x:Math.random()*n,y:Math.random()*t,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:e?3+Math.random()*3:1+Math.random()*1.5,baseRadius:e?3.5:1.5,hue:e?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}const a=[],k=n=>{const t=n.currentTarget;if(!t)return;const e=t.getBoundingClientRect();h=n.clientX-e.left,d=n.clientY-e.top},P=()=>{h=-1e3,d=-1e3};let g=0,f=0;const o=({canvas:n,ctx:t})=>{if(!c){for(let e=0;e<lt;e++)a.push(S(n.width,n.height));g=n.width,f=n.height,c=!0}if(g<20&&n.width>50||f<20&&n.height>50)for(const e of a)e.x=Math.random()*n.width,e.y=Math.random()*n.height;g=n.width,f=n.height,t.clearRect(0,0,n.width,n.height);for(const e of a){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=n.width),e.x>n.width&&(e.x=0),e.y<0&&(e.y=n.height),e.y>n.height&&(e.y=0);const s=e.x-h,r=e.y-d,i=Math.sqrt(s*s+r*r);if(i<O&&i>.1){const p=(O-i)/O;e.vx+=s/i*p*.03,e.vy+=r/i*p*.03}const l=Math.sqrt(e.vx*e.vx+e.vy*e.vy);l>1.2?(e.vx*=.95,e.vy*=.95):l<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<a.length;e++){for(let i=e+1;i<a.length;i++){const l=a[e].x-a[i].x,p=a[e].y-a[i].y;if(Math.abs(l)>m||Math.abs(p)>m)continue;const T=Math.sqrt(l*l+p*p);if(T<m){const C=1-T/m;t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(a[i].x,a[i].y),t.strokeStyle=`rgba(98, 201, 255, ${C*.25})`,t.lineWidth=1,t.stroke()}}const s=a[e].x-h,r=a[e].y-d;if(Math.abs(s)<m*1.5&&Math.abs(r)<m*1.5){const i=Math.sqrt(s*s+r*r);if(i<m*1.5){const l=1-i/(m*1.5);t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(h,d),t.strokeStyle=`rgba(217, 190, 111, ${l*.4})`,t.lineWidth=1.5,t.stroke()}}}for(const e of a){if(e.radius<=0)continue;t.beginPath(),t.arc(e.x,e.y,e.radius,0,Math.PI*2),t.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,t.fill();const s=e.radius*3.5;t.beginPath(),t.arc(e.x,e.y,s,0,Math.PI*2);const r=t.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,s);r.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),r.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),t.fillStyle=r,t.fill()}};return(n,t)=>{const e=x("x-canvas");return w(),D(e,{render:o,onMousemove:k,onMouseleave:P,class:"enchiridion-canvas"})}}}),ct=E(dt,[["__scopeId","data-v-c8f9f032"]]),ht={class:"h-100 w-100",style:{position:"relative"}},pt={class:"reading-pane mx-auto w-100 brand-styled-content"},ut="../../../../../docs/",mt=z({__name:"enchiridion-app",setup(M){const c=Object.assign({"../../../../../docs/Bomb-Bag-System.md":j,"../../../../../docs/CHANGELOG.md":q,"../../../../../docs/Cloudflare-Email-Routing.md":X,"../../../../../docs/Design-Tokens.md":Q,"../../../../../docs/Hello-World.md":K,"../../../../../docs/Project-Philosophy.md":$,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":J,"../../../../../docs/YouMeOS-Federated-Identity.md":Z,"../../../../../docs/analytics_google-analytics-integration.md":ee,"../../../../../docs/authenticity_and_licensing.md":ne,"../../../../../docs/bazaar_pos_premium-upgrades.md":te,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":ae,"../../../../../docs/business/business_compass_pricing_proposal.md":oe,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":ie,"../../../../../docs/business/business_ecosystem_overview.md":se,"../../../../../docs/business/business_patent_strategy.md":re,"../../../../../docs/business/business_sephiroth_godhead_progression.md":le,"../../../../../docs/business/business_storybrand_framework.md":de,"../../../../../docs/business/business_w4_protocol_economy.md":ce,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":he,"../../../../../docs/business/business_youmeos_storybrand_manifesto.md":pe,"../../../../../docs/business/marketing_drip_campaigns.md":ue,"../../../../../docs/business/patent_diagrams_and_prior_art.md":me,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":ge,"../../../../../docs/compass/blueprints/System-Overview.md":ye,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":fe,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":ve,"../../../../../docs/compass/ecosystem/software_manager.md":be,"../../../../../docs/compass/plugins/Bazaar-POS-System.md":we,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":Se,"../../../../../docs/compass/plugins/Bug-Net-System.md":ke,"../../../../../docs/compass/plugins/Hookshot-System.md":Pe,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":Te,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":Ce,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":Ae,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":xe,"../../../../../docs/compass/plugins/Moving-Castle-System.md":Me,"../../../../../docs/compass/plugins/Performance-Widget-System.md":_e,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":Ie,"../../../../../docs/compass/plugins/Silver-Arrow-System.md":Re,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":Oe,"../../../../../docs/compass/plugins/magic-formula-system.md":De,"../../../../../docs/compass/xp-pro-features.md":Ee,"../../../../../docs/github-plugin-updater.md":ze,"../../../../../docs/moving-castle_magic-door.md":We,"../../../../../docs/reference/Ecosystem-Architecture.md":Be,"../../../../../docs/reference/Project-Philosophy.md":Le,"../../../../../docs/reference/versioning.md":Fe,"../../../../../docs/spark_wizards-tower_feature-flags.md":Ue,"../../../../../docs/sparks_omegafile.md":Ge,"../../../../../docs/youmeos/Nomenclature-Mapping.md":Ne,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":He,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Ve,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":Ye,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":je,"../../../../../docs/youmeos/blueprints/Starmap-and-Federation-Blueprint.md":qe,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":Xe,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Qe,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":Ke,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":$e,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":Je,"../../../../../docs/youmeos/design-system/Component-Architecture.md":Ze,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":en,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":nn,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":tn,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":an,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":on,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":sn,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":rn,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":ln,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":dn,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":cn,"../../../../../docs/youmeos/roadmaps/Window-Management.md":hn,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":pn,"../../../../../docs/youmeos/spark-plugs/blackbox.md":un,"../../../../../docs/youmeos/spark-plugs/blackjack.md":mn,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":gn,"../../../../../docs/youmeos/spark-plugs/bugnet.md":yn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":fn,"../../../../../docs/youmeos/spark-plugs/calculator.md":vn,"../../../../../docs/youmeos/spark-plugs/chronos.md":bn,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":wn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":Sn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":kn,"../../../../../docs/youmeos/spark-plugs/gaea.md":Pn,"../../../../../docs/youmeos/spark-plugs/helios.md":Tn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":Cn,"../../../../../docs/youmeos/spark-plugs/jukebox.md":An,"../../../../../docs/youmeos/spark-plugs/local-produce.md":xn,"../../../../../docs/youmeos/spark-plugs/logos.md":Mn,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":_n,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":In,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":Rn,"../../../../../docs/youmeos/spark-plugs/nexus.md":On,"../../../../../docs/youmeos/spark-plugs/noosphere.md":Dn,"../../../../../docs/youmeos/spark-plugs/notepad.md":En,"../../../../../docs/youmeos/spark-plugs/omega-source.md":zn,"../../../../../docs/youmeos/spark-plugs/paint.md":Wn,"../../../../../docs/youmeos/spark-plugs/snake.md":Bn,"../../../../../docs/youmeos/spark-plugs/social-preview.md":Ln,"../../../../../docs/youmeos/spark-plugs/solitaire.md":Fn,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":Un,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":Gn,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":Nn,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":Hn,"../../../../../docs/youmeos/spark-plugs/telescope.md":Vn,"../../../../../docs/youmeos/spark-plugs/terminal.md":Yn,"../../../../../docs/youmeos/spark-plugs/tesseract.md":jn,"../../../../../docs/youmeos/spark-plugs/tourguide.md":qn,"../../../../../docs/youmeos/spark-plugs/trenchess.md":Xn,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":Qn,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":Kn,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":$n,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":Jn,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":Zn,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":et,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":nt,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":tt,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":at,"../../../../../docs/youmeos_nimbus_interaction-modes.md":ot}),h=o=>{const n=o.toLowerCase();return n.includes("start here")?"fal fa-stars":n.includes("blueprints")?"fal fa-drafting-compass":n.includes("user guides")?"fal fa-map-signs":n.includes("core engine")?"fal fa-microchip":n.includes("design system")?"fal fa-swatchbook":n.includes("roadmaps")?"fal fa-road":n.includes("ecosystem")?"fal fa-planet-ringed":n.includes("plugins")||n.includes("sparks")?"fal fa-plug":n.includes("reference")?"fal fa-books":n.includes("general")?"fal fa-book-spells":"fal fa-folder"},d=b(()=>Object.keys(c).map(o=>{const n=o.replace(ut,""),t=n.split("/"),e=t.pop()||"",s=e.replace(".md","");let r=s.split("-").map(v=>v.charAt(0).toUpperCase()+v.slice(1)).join(" "),i="03. Platform Docs",l="General";const p=e.toLowerCase()==="hello-world.md",T=t.length>=2&&["compass","youmeos"].includes(t[0].toLowerCase());p?(i="00. Welcome",l="Start Here"):T?(i=t[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",l=t[1]):t.length>0&&(i="03. Platform Docs",l=t[0]);const C=l.replace(/[-_]/g," ").split(" ").map(v=>v.charAt(0).toUpperCase()+v.slice(1).toLowerCase()).join(" ");let _="fal fa-file-alt",I="#62c9ff";if(C.toLowerCase()==="sparks"){const A=U().apps.find(F=>F.id===s);A&&(_=A.icon||_,I=A.color||I,r=A.title||r)}return{path:o,relativePath:n,title:r,category:C,root:i,icon:_,color:I}}).sort((o,n)=>o.root!==n.root?o.root.localeCompare(n.root):o.category!==n.category?o.category.localeCompare(n.category):o.title.localeCompare(n.title))),S=b(()=>{const o={};return d.value.forEach(n=>{const t=`${n.root}/${n.category}`;o[t]||(o[t]=[]),o[t].push(n)}),Object.keys(o).sort().map(n=>{const t=o[n],e=t[0].category;return{id:n,title:e,icon:h(e),children:t.map(s=>({id:s.path,title:s.title,icon:s.icon}))}})}),a=B("splash"),k=b(()=>d.value.find(o=>o.path===a.value)),P=b(()=>a.value==="splash"||!c[a.value]?null:c[a.value]),g=B(null);N(a,()=>{g.value&&(g.value.scrollTop=0)},{flush:"post"});const f=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;if(f){const o=d.value.find(n=>n.path.toLowerCase().includes(f.toLowerCase()));o&&(a.value=o.path),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")}return typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",o=>{const n=o.detail;if(!n)return;const t=d.value.find(e=>e.path.toLowerCase().includes(n.toLowerCase()));t&&(a.value=t.path)}),(o,n)=>{const t=x("x-spark-splash-action"),e=x("t-spark-splash"),s=x("u-window");return w(),D(s,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","brand-color":"#62c9ff",width:1e3,height:700,"default-nav-pinned":"","nav-items":S.value,"active-nav":a.value,"onUpdate:activeNav":n[0]||(n[0]=r=>a.value=r)},{"app-bar-title":y(()=>[V(Y(k.value?.title||"Enchiridion"),1)]),default:y(()=>[W("div",ht,[P.value?(w(),L("div",{key:1,ref_key:"contentScrollEl",ref:g,class:"enchiridion-content fill-height custom-scrollbar",style:H({"--brand-color":k.value?.color||"#62c9ff"})},[W("div",pt,[u(rt,{content:P.value},null,8,["content"])])],4)):(w(),D(e,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:y(()=>[u(ct)]),actions:y(()=>[u(R,{cols:"12",sm:"4"},{default:y(()=>[u(t,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),u(R,{cols:"12",sm:"4"},{default:y(()=>[u(t,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),u(R,{cols:"12",sm:"4"},{default:y(()=>[u(t,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1},8,["nav-items","active-nav"])}}}),kt=E(mt,[["__scopeId","data-v-3bfeb82d"]]);export{kt as default};
