...
`,oe=`# YouMeOS: The Decentralized Operating System of the Internet
...
`,We=`# YouMeOS: The Sovereign Node Architecture
...
`,Ne=`# Sub-App Layout & Bazaar Routing Investigation
...
`,Ye=`# YouMeOS: The 4D Tesseract Visualization Plan
...
`,qe=`# YouMeOS Web3 Vision & Roadmap
...
`,Ke=`# Window Management & Workspace Orchestration Roadmap
...
`,$e=`# YouMeOS Decentralization & Local-First Architecture Roadmap
...
`,Hn=`# The Swiss Army Knife for Life
...
- Selection clears on mode switch or folder navigation
`,Yn=["innerHTML"],jn=L({__name:"x-markdown",props:{content:{}},setup(M){const c=M,u=b(()=>c.content?F.parse(c.content):"");return(d,S)=>(w(),z("div",{class:"x-markdown-container",innerHTML:u.value},null,8,Yn))}}),qn=E(jn,[["__scopeId","data-v-c9651a1d"]]),Xn=80,m=150,D=200,Qn=L({__name:"enchiridion-canvas",setup(M){let c=!1,u=-1e3,d=-1e3;function S(n,t){const e=Math.random()>.85;return{x:Math.random()*n,y:Math.random()*t,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:e?3+Math.random()*3:1+Math.random()*1.5,baseRadius:e?3.5:1.5,hue:e?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}const a=[],T=n=>{const t=n.currentTarget;if(!t)return;const e=t.getBoundingClientRect();u=n.clientX-e.left,d=n.clientY-e.top},k=()=>{u=-1e3,d=-1e3};let g=0,f=0;const o=({canvas:n,ctx:t})=>{if(!c){for(let e=0;e<Xn;e++)a.push(S(n.width,n.height));g=n.width,f=n.height,c=!0}if(g<20&&n.width>50||f<20&&n.height>50)for(const e of a)e.x=Math.random()*n.width,e.y=Math.random()*n.height;g=n.width,f=n.height,t.clearRect(0,0,n.width,n.height);for(const e of a){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=n.width),e.x>n.width&&(e.x=0),e.y<0&&(e.y=n.height),e.y>n.height&&(e.y=0);const s=e.x-u,r=e.y-d,i=Math.sqrt(s*s+r*r);if(i<D&&i>.1){const h=(D-i)/D;e.vx+=s/i*h*.03,e.vy+=r/i*h*.03}const l=Math.sqrt(e.vx*e.vx+e.vy*e.vy);l>1.2?(e.vx*=.95,e.vy*=.95):l<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<a.length;e++){for(let i=e+1;i<a.length;i++){const l=a[e].x-a[i].x,h=a[e].y-a[i].y;if(Math.abs(l)>m||Math.abs(h)>m)continue;const P=Math.sqrt(l*l+h*h);if(P<m){const C=1-P/m;t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(a[i].x,a[i].y),t.strokeStyle=`rgba(98, 201, 255, ${C*.25})`,t.lineWidth=1,t.stroke()}}const s=a[e].x-u,r=a[e].y-d;if(Math.abs(s)<m*1.5&&Math.abs(r)<m*1.5){const i=Math.sqrt(s*s+r*r);if(i<m*1.5){const l=1-i/(m*1.5);t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(u,d),t.strokeStyle=`rgba(217, 190, 111, ${l*.4})`,t.lineWidth=1.5,t.stroke()}}}for(const e of a){if(e.radius<=0)continue;t.beginPath(),t.arc(e.x,e.y,e.radius,0,Math.PI*2),t.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,t.fill();const s=e.radius*3.5;t.beginPath(),t.arc(e.x,e.y,s,0,Math.PI*2);const r=t.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,s);r.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),r.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),t.fillStyle=r,t.fill()}};return(n,t)=>{const e=x("x-canvas");return w(),O(e,{render:o,onMousemove:T,onMouseleave:k,class:"enchiridion-canvas"})}}}),Kn=E(Qn,[["__scopeId","data-v-c8f9f032"]]),$n={class:"h-100 w-100",style:{position:"relative"}},Jn={class:"reading-pane mx-auto w-100 brand-styled-content"},Zn="../../../../../docs/",et=L({__name:"enchiridion-app",setup(M){const c=Object.assign({"../../../../../docs/CHANGELOG.md":j,"../../../../../docs/Cloudflare-Email-Routing.md":q,"../../../../../docs/Design-Tokens.md":X,"../../../../../docs/Hello-World.md":Q,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":K,"../../../../../docs/YouMeOS-Federated-Identity.md":$,"../../../../../docs/analytics_google-analytics-integration.md":J,"../../../../../docs/authenticity_and_licensing.md":Z,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":ee,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":ne,"../../../../../docs/business/business_sephiroth_godhead_progression.md":te,"../../../../../docs/business/business_w4_protocol_economy.md":ae,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":oe,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":ie,"../../../../../docs/compass/blueprints/System-Overview.md":se,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":re,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":le,"../../../../../docs/compass/ecosystem/software_manager.md":de,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":ce,"../../../../../docs/compass/plugins/Bug-Net-System.md":ue,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":he,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":pe,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":me,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":ge,"../../../../../docs/compass/plugins/Moving-Castle-System.md":ye,"../../../../../docs/compass/plugins/Performance-Widget-System.md":fe,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":ve,"../../../../../docs/compass/plugins/Silver-Arrow-System.md":be,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":we,"../../../../../docs/compass/plugins/magic-formula-system.md":Se,"../../../../../docs/github-plugin-updater.md":Te,"../../../../../docs/moving-castle_magic-door.md":ke,"../../../../../docs/reference/Ecosystem-Architecture.md":Pe,"../../../../../docs/reference/Project-Philosophy.md":Ce,"../../../../../docs/reference/versioning.md":Ae,"../../../../../docs/spark_wizards-tower_feature-flags.md":xe,"../../../../../docs/sparks_omegafile.md":Me,"../../../../../docs/youmeos/Nomenclature-Mapping.md":_e,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":Re,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Ie,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":De,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":Oe,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":Ee,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Le,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":We,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":Be,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":ze,"../../../../../docs/youmeos/design-system/Component-Architecture.md":Ge,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":Ue,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":Fe,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":Ne,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":He,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":Ve,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":Ye,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":je,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":qe,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":Xe,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":Qe,"../../../../../docs/youmeos/roadmaps/Window-Management.md":Ke,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":$e,"../../../../../docs/youmeos/spark-plugs/blackbox.md":Je,"../../../../../docs/youmeos/spark-plugs/blackjack.md":Ze,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":en,"../../../../../docs/youmeos/spark-plugs/bugnet.md":nn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":tn,"../../../../../docs/youmeos/spark-plugs/calculator.md":an,"../../../../../docs/youmeos/spark-plugs/chronos.md":on,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":sn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":rn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":ln,"../../../../../docs/youmeos/spark-plugs/gaea.md":dn,"../../../../../docs/youmeos/spark-plugs/helios.md":cn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":un,"../../../../../docs/youmeos/spark-plugs/jukebox.md":hn,"../../../../../docs/youmeos/spark-plugs/local-produce.md":pn,"../../../../../docs/youmeos/spark-plugs/logos.md":mn,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":gn,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":yn,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":fn,"../../../../../docs/youmeos/spark-plugs/nexus.md":vn,"../../../../../docs/youmeos/spark-plugs/noosphere.md":bn,"../../../../../docs/youmeos/spark-plugs/notepad.md":wn,"../../../../../docs/youmeos/spark-plugs/omega-source.md":Sn,"../../../../../docs/youmeos/spark-plugs/paint.md":Tn,"../../../../../docs/youmeos/spark-plugs/snake.md":kn,"../../../../../docs/youmeos/spark-plugs/social-preview.md":Pn,"../../../../../docs/youmeos/spark-plugs/solitaire.md":Cn,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":An,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":xn,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":Mn,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":_n,"../../../../../docs/youmeos/spark-plugs/telescope.md":Rn,"../../../../../docs/youmeos/spark-plugs/terminal.md":In,"../../../../../docs/youmeos/spark-plugs/tesseract.md":Dn,"../../../../../docs/youmeos/spark-plugs/tourguide.md":On,"../../../../../docs/youmeos/spark-plugs/trenchess.md":En,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":Ln,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":Wn,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":Bn,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":zn,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":Gn,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":Un,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":Fn,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":Nn,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":Hn,"../../../../../docs/youmeos_nimbus_interaction-modes.md":Vn}),u=o=>{const n=o.toLowerCase();return n.includes("start here")?"fal fa-stars":n.includes("blueprints")?"fal fa-drafting-compass":n.includes("user guides")?"fal fa-map-signs":n.includes("core engine")?"fal fa-microchip":n.includes("design system")?"fal fa-swatchbook":n.includes("roadmaps")?"fal fa-road":n.includes("ecosystem")?"fal fa-planet-ringed":n.includes("plugins")||n.includes("sparks")?"fal fa-plug":n.includes("reference")?"fal fa-books":n.includes("general")?"fal fa-book-spells":"fal fa-folder"},d=b(()=>Object.keys(c).map(o=>{const n=o.replace(Zn,""),t=n.split("/"),e=t.pop()||"",s=e.replace(".md","");let r=s.split("-").map(v=>v.charAt(0).toUpperCase()+v.slice(1)).join(" "),i="03. Platform Docs",l="General";const h=e.toLowerCase()==="hello-world.md",P=t.length>=2&&["compass","youmeos"].includes(t[0].toLowerCase());h?(i="00. Welcome",l="Start Here"):P?(i=t[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",l=t[1]):t.length>0&&(i="03. Platform Docs",l=t[0]);const C=l.replace(/[-_]/g," ").split(" ").map(v=>v.charAt(0).toUpperCase()+v.slice(1).toLowerCase()).join(" ");let _="fal fa-file-alt",R="#62c9ff";if(C.toLowerCase()==="sparks"){const A=U().apps.find(G=>G.id===s);A&&(_=A.icon||_,R=A.color||R,r=A.title||r)}return{path:o,relativePath:n,title:r,category:C,root:i,icon:_,color:R}}).sort((o,n)=>o.root!==n.root?o.root.localeCompare(n.root):o.category!==n.category?o.category.localeCompare(n.category):o.title.localeCompare(n.title))),S=b(()=>{const o={};return d.value.forEach(n=>{const t=`${n.root}/${n.category}`;o[t]||(o[t]=[]),o[t].push(n)}),Object.keys(o).sort().map(n=>{const t=o[n],e=t[0].category;return{id:n,title:e,icon:u(e),children:t.map(s=>({id:s.path,title:s.title,icon:s.icon}))}})}),a=B("splash"),T=b(()=>d.value.find(o=>o.path===a.value)),k=b(()=>a.value==="splash"||!c[a.value]?null:c[a.value]),g=B(null);N(a,()=>{g.value&&(g.value.scrollTop=0)},{flush:"post"});const f=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;if(f){const o=d.value.find(n=>n.path.toLowerCase().includes(f.toLowerCase()));o&&(a.value=o.path),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")}return typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",o=>{const n=o.detail;if(!n)return;const t=d.value.find(e=>e.path.toLowerCase().includes(n.toLowerCase()));t&&(a.value=t.path)}),(o,n)=>{const t=x("x-spark-splash-action"),e=x("t-spark-splash"),s=x("u-window");return w(),O(s,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","brand-color":"#62c9ff",width:1e3,height:700,"default-nav-pinned":"","nav-items":S.value,"active-nav":a.value,"onUpdate:activeNav":n[0]||(n[0]=r=>a.value=r)},{"app-bar-title":y(()=>[V(Y(T.value?.title||"Enchiridion"),1)]),default:y(()=>[W("div",$n,[k.value?(w(),z("div",{key:1,ref_key:"contentScrollEl",ref:g,class:"enchiridion-content fill-height custom-scrollbar",style:H({"--brand-color":T.value?.color||"#62c9ff"})},[W("div",Jn,[p(qn,{content:k.value},null,8,["content"])])],4)):(w(),O(e,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:y(()=>[p(Kn)]),actions:y(()=>[p(I,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),p(I,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),p(I,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1},8,["nav-items","active-nav"])}}}),lt=E(et,[["__scopeId","data-v-310c4fef"]]);export{lt as default};
