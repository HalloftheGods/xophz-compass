import{f as y,co as k,e as B,d as S,V as C,ca as E,cd as H,l as M,m as _}from"./vendor-BjFTOFDN.js";import{a as L}from"./index-D5QMxdcI.js";import"./vendor-core-BanDfL0c.js";import"./vendor-vuetify-DqM-Cv6Y.js";import"./vendor-three-DbgnMstn.js";import"./vendor-echarts-Dag9Zoru.js";const T=y({name:"MagicFormulaIframe",setup(){const u=k(),i=B(null);return{wpPage:S(()=>u.meta.wpPage||"forminator"),iframeRef:i,injectStyles:()=>{const a=i.value?.$el||i.value;if(a)try{const t=a.contentDocument||a.contentWindow?.document;if(!t)return;t.documentElement.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe"),t.body.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe");let p=0;const d=()=>{if(!a||!t.body)return;const r=t.querySelector(".sui-wrap, .forminator-ui, .wpmud-admin-wrap")||t.getElementById("wpbody-content")||t.body;if(!r)return;let o=r.offsetHeight||0;const n=r.getBoundingClientRect();n.height>o&&(o=Math.ceil(n.height)),r.querySelectorAll(".sui-box, .sui-row, .sui-header, .sui-footer, .wpmud-footer, form, table, .tablenav, .sui-box-body").forEach(m=>{const l=m,b=l.offsetTop+l.offsetHeight;b>o&&(o=b)});const s=Math.max(o+16,500);Math.abs(s-p)>4&&(p=s,a.style.height=`${s}px`,a.style.minHeight=`${s}px`)},f=r=>{let o=r.target,n=!1;for(;o&&o!==t.body&&o!==t.documentElement;){const m=t.defaultView?.getComputedStyle(o)?.overflowY;if((m==="auto"||m==="scroll")&&o.scrollHeight>o.clientHeight){const l=o.scrollTop<=0&&r.deltaY<0,b=o.scrollTop+o.clientHeight>=o.scrollHeight&&r.deltaY>0;if(!l&&!b){n=!0;break}}o=o.parentElement}if(n)return;const c=a.closest(".v-main")||document.querySelector(".x-sub-app-layout > .v-main")||document.querySelector("#app .v-main");c?c.scrollTop+=r.deltaY:window.scrollBy({top:r.deltaY,behavior:"auto"})};t.removeEventListener("wheel",f),t.addEventListener("wheel",f,{passive:!0});const g=new ResizeObserver(d),h=t.querySelector(".sui-wrap, .forminator-ui");h&&g.observe(h);const w=t.getElementById("wpbody-content");w&&g.observe(w),new MutationObserver(d).observe(t.body,{childList:!0,subtree:!0,attributes:!0}),d(),[100,300,600,1e3,2e3,3500].forEach(r=>{setTimeout(d,r)});let e=t.getElementById("compass-sui-overrides");e||(e=t.createElement("style"),e.id="compass-sui-overrides",e.innerHTML=`
          ...
          `,t.head.appendChild(e))}catch(t){console.warn("[Magic Formula] Could not inject iframe styles",t)}}}}}),I={class:"magic-formula-iframe-container position-relative"};function $(u,i,x,v,a,t){const p=C("x-iframe");return E(),H("div",I,[M(p,{ref:"iframeRef",name:"compass-sub-app",class:"forminator-iframe",src:`/wp-admin/admin.php?page=${u.wpPage}&compass_iframe=1&embed=1&theme=transparent`,onLoad:u.injectStyles},null,8,["src","onLoad"]),i[0]||(i[0]=_("div",{class:"browser-overlay pointer-events-none"},null,-1))])}const F=L(T,[["render",$],["__scopeId","data-v-26024780"]]);export{F as default};
