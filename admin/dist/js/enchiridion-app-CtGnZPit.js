...
`,$=`# The W4 Protocol: Fractal Architecture & Civilizational Infrastructure
...
`,J=`# YouMeOS Federated Identity Architecture
...
`,ne=`# Bazaar POS Premium Upgrades
...
`,te=`# Sovereignty Box Architecture & Value Ladder
...
`,ae=`# Compass Suite: Early Access Pricing & Marketing Proposal
...
`,oe=`# YouMeOS & COMPASS: Patent Filing Strategy & Candidate Concepts
...
`,re=`# The Godhead Progression: Thoth, Qabalah, & The 10-Layer Lineage
...
`,se=`# YouMeOS & COMPASS: The StoryBrand Framework
...
`,le=`# The W4 Protocol: A 4D Fractal Economic Operating System
...
`,de=`# YouMeOS: The Decentralized Operating System of the Internet
...
`,ce=`# YouMeOS: The 10-Year Vision & StoryBrand Manifesto
...
`,he=`# YouMeOS Patent Analysis: Prior Art & Sequence Diagrams
...
\`\`\`
`,ue=`# YouMeOS Taxonomy & Terminology
...
`,ye=`# Software Manager (Compass Suite)
...
`,fe=`# Bazaar POS (Point of Sale) System
...
`,ke=`# Magic Mirror: Competitive Benchmarking & Performance Analytics
...
`,xe=`# Treasure Trove & Treasure Map System
...
`,De=`# The Hall of the Gods Ecosystem Architecture
...
`,Le=`# YouMeOS Nomenclature & Terminology Map
...
`,Be=`# Helios Modules Documentation
...
`,Ge=`# Spark Federation Protocol & Security Architecture
...
`,Ve=`# YouMeOS: The Asynchronous Cosmos
...
`,Ye=`# YouMeOS: The Sovereign Node Architecture
...
`,$e=`# Sub-App Layout & Bazaar Routing Investigation
...
`,en=`# YouMeOS: The 4D Tesseract Visualization Plan
...
`,nn=`# Three.js Legacy Migration Guide
...
`,tn=`# YouMeOS Web3 Vision & Roadmap
...
`,on=`# WebGPU Shader Migration Plan
...
`,rn=`# Window Management & Workspace Orchestration Roadmap
...
`,sn=`# YouMeOS Decentralization & Local-First Architecture Roadmap
...
## Details
This spark operates natively within the YouMeOS environment, providing seamless integration with the glassmorphic desktop and True North aesthetics.
`,$n=`# Getting Started with YouMeOS
...
`,Jn=`# The Swiss Army Knife for Life
...
- Selection clears on mode switch or folder navigation
`,et=["innerHTML"],nt=W({__name:"x-markdown",props:{content:{}},setup(x){const c=x,h=b(()=>c.content?G.parse(c.content):"");return(d,S)=>(w(),B("div",{class:"x-markdown-container",innerHTML:h.value},null,8,et))}}),tt=E(nt,[["__scopeId","data-v-c9651a1d"]]),at=80,m=150,D=200,it=W({__name:"enchiridion-canvas",setup(x){let c=!1,h=-1e3,d=-1e3;function S(n,t){const e=Math.random()>.85;return{x:Math.random()*n,y:Math.random()*t,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:e?3+Math.random()*3:1+Math.random()*1.5,baseRadius:e?3.5:1.5,hue:e?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}const a=[],k=n=>{const t=n.currentTarget;if(!t)return;const e=t.getBoundingClientRect();h=n.clientX-e.left,d=n.clientY-e.top},T=()=>{h=-1e3,d=-1e3};let g=0,f=0;const i=({canvas:n,ctx:t})=>{if(!c){for(let e=0;e<at;e++)a.push(S(n.width,n.height));g=n.width,f=n.height,c=!0}if(g<20&&n.width>50||f<20&&n.height>50)for(const e of a)e.x=Math.random()*n.width,e.y=Math.random()*n.height;g=n.width,f=n.height,t.clearRect(0,0,n.width,n.height);for(const e of a){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=n.width),e.x>n.width&&(e.x=0),e.y<0&&(e.y=n.height),e.y>n.height&&(e.y=0);const r=e.x-h,s=e.y-d,o=Math.sqrt(r*r+s*s);if(o<D&&o>.1){const u=(D-o)/D;e.vx+=r/o*u*.03,e.vy+=s/o*u*.03}const l=Math.sqrt(e.vx*e.vx+e.vy*e.vy);l>1.2?(e.vx*=.95,e.vy*=.95):l<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<a.length;e++){for(let o=e+1;o<a.length;o++){const l=a[e].x-a[o].x,u=a[e].y-a[o].y;if(Math.abs(l)>m||Math.abs(u)>m)continue;const P=Math.sqrt(l*l+u*u);if(P<m){const C=1-P/m;t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(a[o].x,a[o].y),t.strokeStyle=`rgba(98, 201, 255, ${C*.25})`,t.lineWidth=1,t.stroke()}}const r=a[e].x-h,s=a[e].y-d;if(Math.abs(r)<m*1.5&&Math.abs(s)<m*1.5){const o=Math.sqrt(r*r+s*s);if(o<m*1.5){const l=1-o/(m*1.5);t.beginPath(),t.moveTo(a[e].x,a[e].y),t.lineTo(h,d),t.strokeStyle=`rgba(217, 190, 111, ${l*.4})`,t.lineWidth=1.5,t.stroke()}}}for(const e of a){if(e.radius<=0)continue;t.beginPath(),t.arc(e.x,e.y,e.radius,0,Math.PI*2),t.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,t.fill();const r=e.radius*3.5;t.beginPath(),t.arc(e.x,e.y,r,0,Math.PI*2);const s=t.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,r);s.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),s.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),t.fillStyle=s,t.fill()}};return(n,t)=>{const e=M("x-canvas");return w(),O(e,{render:i,onMousemove:k,onMouseleave:T,class:"enchiridion-canvas"})}}}),ot=E(it,[["__scopeId","data-v-c8f9f032"]]),rt={class:"h-100 w-100",style:{position:"relative"}},st={class:"reading-pane mx-auto w-100 brand-styled-content"},lt="../../../../../docs/",dt=W({__name:"enchiridion-app",setup(x){const c=Object.assign({"../../../../../docs/CHANGELOG.md":j,"../../../../../docs/Cloudflare-Email-Routing.md":q,"../../../../../docs/Design-Tokens.md":X,"../../../../../docs/Hello-World.md":Q,"../../../../../docs/Project-Philosophy.md":K,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":$,"../../../../../docs/YouMeOS-Federated-Identity.md":J,"../../../../../docs/analytics_google-analytics-integration.md":Z,"../../../../../docs/authenticity_and_licensing.md":ee,"../../../../../docs/bazaar_pos_premium-upgrades.md":ne,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":te,"../../../../../docs/business/business_compass_pricing_proposal.md":ae,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":ie,"../../../../../docs/business/business_patent_strategy.md":oe,"../../../../../docs/business/business_sephiroth_godhead_progression.md":re,"../../../../../docs/business/business_storybrand_framework.md":se,"../../../../../docs/business/business_w4_protocol_economy.md":le,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":de,"../../../../../docs/business/business_youmeos_storybrand_manifesto.md":ce,"../../../../../docs/business/patent_diagrams_and_prior_art.md":he,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":ue,"../../../../../docs/compass/blueprints/System-Overview.md":pe,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":me,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":ge,"../../../../../docs/compass/ecosystem/software_manager.md":ye,"../../../../../docs/compass/plugins/Bazaar-POS-System.md":fe,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":ve,"../../../../../docs/compass/plugins/Bug-Net-System.md":be,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":we,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":Se,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":ke,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":Te,"../../../../../docs/compass/plugins/Moving-Castle-System.md":Pe,"../../../../../docs/compass/plugins/Performance-Widget-System.md":Ce,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":Ae,"../../../../../docs/compass/plugins/Silver-Arrow-System.md":Me,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":xe,"../../../../../docs/compass/plugins/magic-formula-system.md":_e,"../../../../../docs/github-plugin-updater.md":Ie,"../../../../../docs/moving-castle_magic-door.md":Re,"../../../../../docs/reference/Ecosystem-Architecture.md":De,"../../../../../docs/reference/Project-Philosophy.md":Oe,"../../../../../docs/reference/versioning.md":Ee,"../../../../../docs/spark_wizards-tower_feature-flags.md":We,"../../../../../docs/sparks_omegafile.md":ze,"../../../../../docs/youmeos/Nomenclature-Mapping.md":Le,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":Be,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Ue,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":Fe,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":Ge,"../../../../../docs/youmeos/blueprints/Starmap-and-Federation-Blueprint.md":Ne,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":He,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Ve,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":Ye,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":je,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":qe,"../../../../../docs/youmeos/design-system/Component-Architecture.md":Xe,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":Qe,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":Ke,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":$e,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":Je,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":Ze,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":en,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":nn,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":tn,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":an,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":on,"../../../../../docs/youmeos/roadmaps/Window-Management.md":rn,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":sn,"../../../../../docs/youmeos/spark-plugs/blackbox.md":ln,"../../../../../docs/youmeos/spark-plugs/blackjack.md":dn,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":cn,"../../../../../docs/youmeos/spark-plugs/bugnet.md":hn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":un,"../../../../../docs/youmeos/spark-plugs/calculator.md":pn,"../../../../../docs/youmeos/spark-plugs/chronos.md":mn,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":gn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":yn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":fn,"../../../../../docs/youmeos/spark-plugs/gaea.md":vn,"../../../../../docs/youmeos/spark-plugs/helios.md":bn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":wn,"../../../../../docs/youmeos/spark-plugs/jukebox.md":Sn,"../../../../../docs/youmeos/spark-plugs/local-produce.md":kn,"../../../../../docs/youmeos/spark-plugs/logos.md":Tn,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":Pn,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":Cn,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":An,"../../../../../docs/youmeos/spark-plugs/nexus.md":Mn,"../../../../../docs/youmeos/spark-plugs/noosphere.md":xn,"../../../../../docs/youmeos/spark-plugs/notepad.md":_n,"../../../../../docs/youmeos/spark-plugs/omega-source.md":In,"../../../../../docs/youmeos/spark-plugs/paint.md":Rn,"../../../../../docs/youmeos/spark-plugs/snake.md":Dn,"../../../../../docs/youmeos/spark-plugs/social-preview.md":On,"../../../../../docs/youmeos/spark-plugs/solitaire.md":En,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":Wn,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":zn,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":Ln,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":Bn,"../../../../../docs/youmeos/spark-plugs/telescope.md":Un,"../../../../../docs/youmeos/spark-plugs/terminal.md":Fn,"../../../../../docs/youmeos/spark-plugs/tesseract.md":Gn,"../../../../../docs/youmeos/spark-plugs/tourguide.md":Nn,"../../../../../docs/youmeos/spark-plugs/trenchess.md":Hn,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":Vn,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":Yn,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":jn,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":qn,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":Xn,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":Qn,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":Kn,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":$n,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":Jn,"../../../../../docs/youmeos_nimbus_interaction-modes.md":Zn}),h=i=>{const n=i.toLowerCase();return n.includes("start here")?"fal fa-stars":n.includes("blueprints")?"fal fa-drafting-compass":n.includes("user guides")?"fal fa-map-signs":n.includes("core engine")?"fal fa-microchip":n.includes("design system")?"fal fa-swatchbook":n.includes("roadmaps")?"fal fa-road":n.includes("ecosystem")?"fal fa-planet-ringed":n.includes("plugins")||n.includes("sparks")?"fal fa-plug":n.includes("reference")?"fal fa-books":n.includes("general")?"fal fa-book-spells":"fal fa-folder"},d=b(()=>Object.keys(c).map(i=>{const n=i.replace(lt,""),t=n.split("/"),e=t.pop()||"",r=e.replace(".md","");let s=r.split("-").map(v=>v.charAt(0).toUpperCase()+v.slice(1)).join(" "),o="03. Platform Docs",l="General";const u=e.toLowerCase()==="hello-world.md",P=t.length>=2&&["compass","youmeos"].includes(t[0].toLowerCase());u?(o="00. Welcome",l="Start Here"):P?(o=t[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",l=t[1]):t.length>0&&(o="03. Platform Docs",l=t[0]);const C=l.replace(/[-_]/g," ").split(" ").map(v=>v.charAt(0).toUpperCase()+v.slice(1).toLowerCase()).join(" ");let _="fal fa-file-alt",I="#62c9ff";if(C.toLowerCase()==="sparks"){const A=F().apps.find(U=>U.id===r);A&&(_=A.icon||_,I=A.color||I,s=A.title||s)}return{path:i,relativePath:n,title:s,category:C,root:o,icon:_,color:I}}).sort((i,n)=>i.root!==n.root?i.root.localeCompare(n.root):i.category!==n.category?i.category.localeCompare(n.category):i.title.localeCompare(n.title))),S=b(()=>{const i={};return d.value.forEach(n=>{const t=`${n.root}/${n.category}`;i[t]||(i[t]=[]),i[t].push(n)}),Object.keys(i).sort().map(n=>{const t=i[n],e=t[0].category;return{id:n,title:e,icon:h(e),children:t.map(r=>({id:r.path,title:r.title,icon:r.icon}))}})}),a=L("splash"),k=b(()=>d.value.find(i=>i.path===a.value)),T=b(()=>a.value==="splash"||!c[a.value]?null:c[a.value]),g=L(null);N(a,()=>{g.value&&(g.value.scrollTop=0)},{flush:"post"});const f=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;if(f){const i=d.value.find(n=>n.path.toLowerCase().includes(f.toLowerCase()));i&&(a.value=i.path),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")}return typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",i=>{const n=i.detail;if(!n)return;const t=d.value.find(e=>e.path.toLowerCase().includes(n.toLowerCase()));t&&(a.value=t.path)}),(i,n)=>{const t=M("x-spark-splash-action"),e=M("t-spark-splash"),r=M("u-window");return w(),O(r,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","brand-color":"#62c9ff",width:1e3,height:700,"default-nav-pinned":"","nav-items":S.value,"active-nav":a.value,"onUpdate:activeNav":n[0]||(n[0]=s=>a.value=s)},{"app-bar-title":y(()=>[V(Y(k.value?.title||"Enchiridion"),1)]),default:y(()=>[z("div",rt,[T.value?(w(),B("div",{key:1,ref_key:"contentScrollEl",ref:g,class:"enchiridion-content fill-height custom-scrollbar",style:H({"--brand-color":k.value?.color||"#62c9ff"})},[z("div",st,[p(tt,{content:T.value},null,8,["content"])])],4)):(w(),O(e,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:y(()=>[p(ot)]),actions:y(()=>[p(R,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),p(R,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),p(R,{cols:"12",sm:"4"},{default:y(()=>[p(t,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1},8,["nav-items","active-nav"])}}}),ft=E(dt,[["__scopeId","data-v-3bfeb82d"]]);export{ft as default};
