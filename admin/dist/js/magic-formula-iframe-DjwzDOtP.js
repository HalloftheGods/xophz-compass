import{f as k,co as y,e as B,d as S,V as C,ca as E,cd as H,l as L,m as M}from"./vendor-BVn3J3rq.js";import{a as _}from"./index-CZtjXyj9.js";import"./vendor-core-BanDfL0c.js";import"./vendor-vuetify-BY-f327J.js";import"./vendor-three-DbgnMstn.js";import"./vendor-echarts-BxQ3pWnx.js";const T=k({name:"MagicFormulaIframe",setup(){const p=y(),i=B(null);return{wpPage:S(()=>p.meta.wpPage||"forminator"),iframeRef:i,injectStyles:()=>{const a=i.value?.$el||i.value;if(a)try{const t=a.contentDocument||a.contentWindow?.document;if(!t)return;t.documentElement.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe"),t.body.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe");let u=0;const m=()=>{if(!a||!t.body)return;const r=t.querySelector(".sui-wrap, .forminator-ui, .wpmud-admin-wrap")||t.getElementById("wpbody-content")||t.body;if(!r)return;let o=r.offsetHeight||0;const n=r.getBoundingClientRect();n.height>o&&(o=Math.ceil(n.height)),r.querySelectorAll(".sui-box, .sui-row, .sui-header, .sui-footer, .wpmud-footer, form, table, .tablenav, .sui-box-body").forEach(d=>{const l=d,b=l.offsetTop+l.offsetHeight;b>o&&(o=b)});const s=Math.max(o+16,500);Math.abs(s-u)>4&&(u=s,a.style.height=`${s}px`,a.style.minHeight=`${s}px`)},f=r=>{let o=r.target,n=!1;for(;o&&o!==t.body&&o!==t.documentElement;){const d=t.defaultView?.getComputedStyle(o)?.overflowY;if((d==="auto"||d==="scroll")&&o.scrollHeight>o.clientHeight){const l=o.scrollTop<=0&&r.deltaY<0,b=o.scrollTop+o.clientHeight>=o.scrollHeight&&r.deltaY>0;if(!l&&!b){n=!0;break}}o=o.parentElement}if(n)return;const c=a.closest(".v-main")||document.querySelector(".x-sub-app-layout > .v-main")||document.querySelector("#app .v-main");c?c.scrollTop+=r.deltaY:window.scrollBy({top:r.deltaY,behavior:"auto"})};t.removeEventListener("wheel",f),t.addEventListener("wheel",f,{passive:!0});const g=new ResizeObserver(m),h=t.querySelector(".sui-wrap, .forminator-ui");h&&g.observe(h);const w=t.getElementById("wpbody-content");w&&g.observe(w),new MutationObserver(m).observe(t.body,{childList:!0,subtree:!0,attributes:!0}),m(),[100,300,600,1e3,2e3,3500].forEach(r=>{setTimeout(m,r)});let e=t.getElementById("compass-sui-overrides");e||(e=t.createElement("style"),e.id="compass-sui-overrides",e.innerHTML=`
            ...
            *::-webkit-scrollbar {
            ...
            .sui-modal, .sui-dialog, .forminator-modal, .sui-modal-slide, .sui-modal-slide.sui-active, .sui-modal-content, .sui-dialog-content {
            ...
            .sui-modal .sui-box, .sui-dialog .sui-box, .sui-modal-content .sui-box, [class*="wds-"] .sui-modal .sui-box, [class*="wds-"] .sui-dialog .sui-box, .forminator-modal .sui-box {
          ...
          `,t.head.appendChild(e))}catch(t){console.warn("[Magic Formula] Could not inject iframe styles",t)}}}}}),I={class:"magic-formula-iframe-container position-relative"};function O(p,i,x,v,a,t){const u=C("x-iframe");return E(),H("div",I,[L(u,{ref:"iframeRef",name:"compass-sub-app",class:"forminator-iframe",src:`/wp-admin/admin.php?page=${p.wpPage}&compass_iframe=1&embed=1&theme=transparent`,onLoad:p.injectStyles},null,8,["src","onLoad"]),i[0]||(i[0]=M("div",{class:"browser-overlay pointer-events-none"},null,-1))])}const F=_(T,[["render",O],["__scopeId","data-v-0c9e6380"]]);export{F as default};
