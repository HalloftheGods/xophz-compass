...
`,fe=`# Treasure Trove & Treasure Map System
...
`,ve=`# The Hall of the Gods Ecosystem Architecture
...
`,Se=`# Helios Modules Documentation
...
`,Ce=`# YouMeOS: The Asynchronous Cosmos
...
`,Me=`# YouMeOS: The Sovereign Node Architecture
...
`,Ae=`# YouMeOS: Sovereign Identity Architecture 
...
`,Ee=`# Sub-App Layout & Bazaar Routing Investigation
...
`,ze=`# YouMeOS: The 4D Tesseract Visualization Plan
...
`,We=`# Three.js Legacy Migration Guide
...
`,Ue=`# YouMeOS Web3 Vision & Roadmap
...
`,Ge=`# WebGPU Shader Migration Plan
...
`,Fe=`# Window Management & Workspace Orchestration Roadmap
...
`,Ne=`# YouMeOS Decentralization & Local-First Architecture Roadmap
...
`,Ve=`# Getting Started with YouMeOS
...
`,He=["innerHTML"],je=H({__name:"x-markdown",props:{content:{}},setup(z){const w=z,h=I(()=>w.content?J.parse(w.content):"");return(P,s)=>(y(),C("div",{class:"x-markdown-container",innerHTML:h.value},null,8,He))}}),Ye=j(je,[["__scopeId","data-v-c9651a1d"]]),qe=80,k=150,V=200,Xe=H({__name:"enchiridion-canvas",setup(z){const w=M(null);let h=0,P=null;function s(o,i){const m=Math.random()>.85;return{x:Math.random()*o,y:Math.random()*i,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:m?3+Math.random()*3:1+Math.random()*1.5,baseRadius:m?3.5:1.5,hue:m?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}return K(()=>{const o=w.value;if(!o)return;const i=o.getContext("2d");if(!i)return;let m=-1e3,p=-1e3,f=0,S=0;const r=[],T=()=>{const e=o.parentElement;if(e){if(o.width=e.clientWidth,o.height=e.clientHeight,f<20&&o.width>50||S<20&&o.height>50)for(const n of r)n.x=Math.random()*o.width,n.y=Math.random()*o.height;f=o.width,S=o.height}};T();for(let e=0;e<qe;e++)r.push(s(o.width,o.height));const D=e=>{const n=o.getBoundingClientRect();m=e.clientX-n.left,p=e.clientY-n.top},E=()=>{m=-1e3,p=-1e3};o.addEventListener("mousemove",D),o.addEventListener("mouseleave",E);const A=()=>{if(!(!i||!o)){i.clearRect(0,0,o.width,o.height);for(const e of r){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=o.width),e.x>o.width&&(e.x=0),e.y<0&&(e.y=o.height),e.y>o.height&&(e.y=0);const n=e.x-m,t=e.y-p,a=Math.sqrt(n*n+t*t);if(a<V&&a>.1){const v=(V-a)/V;e.vx+=n/a*v*.03,e.vy+=t/a*v*.03}const l=Math.sqrt(e.vx*e.vx+e.vy*e.vy);l>1.2?(e.vx*=.95,e.vy*=.95):l<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<r.length;e++){for(let a=e+1;a<r.length;a++){const l=r[e].x-r[a].x,v=r[e].y-r[a].y;if(Math.abs(l)>k||Math.abs(v)>k)continue;const d=Math.sqrt(l*l+v*v);if(d<k){const g=1-d/k;i.beginPath(),i.moveTo(r[e].x,r[e].y),i.lineTo(r[a].x,r[a].y),i.strokeStyle=`rgba(98, 201, 255, ${g*.25})`,i.lineWidth=1,i.stroke()}}const n=r[e].x-m,t=r[e].y-p;if(Math.abs(n)<k*1.5&&Math.abs(t)<k*1.5){const a=Math.sqrt(n*n+t*t);if(a<k*1.5){const l=1-a/(k*1.5);i.beginPath(),i.moveTo(r[e].x,r[e].y),i.lineTo(m,p),i.strokeStyle=`rgba(217, 190, 111, ${l*.4})`,i.lineWidth=1.5,i.stroke()}}}for(const e of r){if(e.radius<=0)continue;i.beginPath(),i.arc(e.x,e.y,e.radius,0,Math.PI*2),i.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,i.fill();const n=e.radius*3.5;i.beginPath(),i.arc(e.x,e.y,n,0,Math.PI*2);const t=i.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,n);t.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),t.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),i.fillStyle=t,i.fill()}h=requestAnimationFrame(A)}},L=new ResizeObserver(T);o.parentElement&&L.observe(o.parentElement),h=requestAnimationFrame(A),P=()=>{cancelAnimationFrame(h),L.disconnect(),o.removeEventListener("mousemove",D),o.removeEventListener("mouseleave",E)}}),$(()=>{P?.()}),(o,i)=>(y(),C("canvas",{ref_key:"canvasRef",ref:w,class:"enchiridion-canvas"},null,512))}}),Je=j(Xe,[["__scopeId","data-v-37aa8a33"]]),Ke={class:"w-100 enchiridion-nav-ui",style:{height:"100%",display:"flex","flex-direction":"column"}},$e={class:"d-flex justify-center align-center opacity-70 mr-4",style:{width:"24px"}},Ze={class:"px-3 pt-2 pb-2 text-caption text-uppercase font-weight-bold header-label"},Qe={class:"h-100 w-100",style:{position:"relative"}},en={class:"reading-pane mx-auto w-100"},nn="../../../../../docs/",tn=H({__name:"enchiridion-app",setup(z){const w=Object.assign({"../../../../../docs/CHANGELOG.md":te,"../../../../../docs/Hello-World.md":ae,"../../../../../docs/authenticity_and_licensing.md":oe,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":ie,"../../../../../docs/compass/blueprints/System-Overview.md":re,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":se,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":le,"../../../../../docs/compass/ecosystem/software_manager.md":de,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":ce,"../../../../../docs/compass/plugins/Bug-Net-System.md":pe,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":ue,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":he,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":me,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":ge,"../../../../../docs/compass/plugins/Moving-Castle-System.md":ye,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":fe,"../../../../../docs/reference/Ecosystem-Architecture.md":ve,"../../../../../docs/reference/Project-Philosophy.md":be,"../../../../../docs/reference/versioning.md":we,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":Se,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Pe,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":Te,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":ke,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":xe,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Ce,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":Me,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":Ae,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":Re,"../../../../../docs/youmeos/design-system/Component-Architecture.md":_e,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":Ie,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":De,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":Ee,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":Le,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":Oe,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":ze,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":We,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":Ue,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":Be,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":Ge,"../../../../../docs/youmeos/roadmaps/Window-Management.md":Fe,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":Ne,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":Ve}),h=I(()=>Object.keys(w).map(n=>{const t=n.replace(nn,""),a=t.split("/"),l=a.pop()||"",v=l.replace(".md","").split("-").map(b=>b.charAt(0).toUpperCase()+b.slice(1)).join(" ");let d="03. Platform Docs",g="General";l.toLowerCase()==="hello-world.md"?(d="00. Welcome",g="Start Here"):a.length>=2&&["compass","youmeos"].includes(a[0].toLowerCase())?(d=a[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",g=a[1]):a.length>0&&(d="03. Platform Docs",g=a[0]);const Y=g.replace(/[-_]/g," ").split(" ").map(b=>b.charAt(0).toUpperCase()+b.slice(1).toLowerCase()).join(" ");return{path:n,relativePath:t,title:v,category:Y,root:d}}).sort((n,t)=>n.root!==t.root?n.root.localeCompare(t.root):n.category!==t.category?n.category.localeCompare(t.category):n.title.localeCompare(t.title))),P=I(()=>{const n={};h.value.forEach(a=>{n[a.root]||(n[a.root]={}),n[a.root][a.category]||(n[a.root][a.category]=[]),n[a.root][a.category].push(a)});const t={};return Object.keys(n).sort().forEach(a=>{t[a]={},Object.keys(n[a]).sort().forEach(l=>{t[a][l]=n[a][l]})}),t}),s=M(null),o=M(null),i=I(()=>!s.value||!w[s.value]?`# Welcome to the Source

Please select a document from the rail to begin your reading.`:w[s.value]),m=n=>{s.value=n};Z(s,()=>{o.value&&(o.value.scrollTop=0)},{flush:"post"});const p=M(null),f=M(null),S=M(0),r=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;let T=null;r&&(T=h.value.find(n=>n.path.toLowerCase().includes(r.toLowerCase())),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")),!s.value&&T&&(s.value=T.path,p.value=T.root,f.value=T.category,S.value=1),typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",n=>{const t=n.detail;if(t){const a=h.value.find(l=>l.path.toLowerCase().includes(t.toLowerCase()));a&&(s.value=a.path,p.value=a.root,f.value=a.category,S.value=1)}});const D=(n,t)=>{p.value=t,f.value=n,S.value=1},E=()=>{S.value=0},A=I(()=>{if(!s.value)return null;const n=h.value.findIndex(t=>t.path===s.value);return n>=0&&n<h.value.length-1?h.value[n+1]:null}),L=()=>{const n=A.value;n&&(m(n.path),(f.value!==n.category||p.value!==n.root)&&(f.value=n.category,p.value=n.root))},e=n=>{const t=n.toLowerCase();return t.includes("start here")?"fal fa-stars":t.includes("blueprints")?"fal fa-drafting-compass":t.includes("user guides")?"fal fa-map-signs":t.includes("core engine")?"fal fa-microchip":t.includes("design system")?"fal fa-swatchbook":t.includes("roadmaps")?"fal fa-road":t.includes("ecosystem")?"fal fa-planet-ringed":t.includes("plugins")?"fal fa-plug":t.includes("reference")?"fal fa-books":t.includes("general")?"fal fa-book-spells":"fal fa-folder"};return(n,t)=>{const a=W("x-spark-splash-action"),l=W("t-spark-splash"),v=W("u-window");return y(),R(v,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","default-width":1e3,"default-height":700,"default-nav-pinned":!0},{"nav-content":u(()=>[x("div",Ke,[c(ee,{modelValue:S.value,"onUpdate:modelValue":t[1]||(t[1]=d=>S.value=d),transition:"window-fade-transition","reverse-transition":"window-fade-transition",style:{height:"100%",width:"100%"}},{default:u(()=>[c(X,{value:0,style:{height:"100%",width:"100%","overflow-y":"auto","overflow-x":"hidden"},class:"custom-scrollbar"},{default:u(()=>[c(N,{nav:"",density:"compact",class:"pb-8","bg-color":"transparent"},{default:u(()=>[c(_,{title:"The Source",class:U(["mb-1 font-weight-bold category-list-item mt-2",s.value?"opacity-80":"text-primary"]),onClick:t[0]||(t[0]=d=>s.value=null)},{prepend:u(()=>[x("div",$e,[c(ne,{icon:"fal fa-book-spells",class:U(s.value?"":"text-primary")},null,8,["class"])])]),_:1},8,["class"]),(y(!0),C(O,null,B(P.value,(d,g)=>(y(),C(O,{key:g},[x("div",{class:U(["px-3 pt-3 pb-2 text-caption text-uppercase font-weight-bold header-label",g!==Object.keys(P.value)[0]?"mt-4":""])},G(g),3),(y(!0),C(O,null,B(d,(Y,b)=>(y(),R(_,{key:b,title:String(b),"prepend-icon":e(String(b)),"append-icon":"fal fa-chevron-right",color:"#62c9ff",class:"mb-1 opacity-80",onClick:an=>D(String(b),String(g))},null,8,["title","prepend-icon","onClick"]))),128))],64))),128))]),_:1})]),_:1}),c(X,{value:1,style:{height:"100%",width:"100%",display:"flex","flex-direction":"column"}},{default:u(()=>[c(N,{nav:"",density:"compact",class:"flex-grow-1 custom-scrollbar","bg-color":"transparent",style:{"overflow-y":"auto","overflow-x":"hidden"}},{default:u(()=>[c(_,{"prepend-icon":"fal fa-arrow-left",title:"Back",class:"mb-2 back-btn",onClick:E}),x("div",Ze,[q(G(p.value)+" ",1),t[2]||(t[2]=x("span",{class:"opacity-50 mx-1"},"/",-1)),q(" "+G(f.value),1)]),(y(!0),C(O,null,B(p.value&&f.value&&P.value[p.value]?P.value[p.value][f.value]:[],d=>(y(),R(_,{key:d.path,title:d.title,"prepend-icon":"fal fa-file-alt",active:s.value===d.path,class:"mb-1",color:"#62c9ff",onClick:g=>m(d.path)},null,8,["title","active","onClick"]))),128))]),_:1}),A.value?(y(),R(N,{key:0,nav:"",density:"compact",class:"mt-auto px-2","bg-color":"transparent"},{default:u(()=>[c(_,{"prepend-icon":"fal fa-arrow-right",title:"Next",class:"opacity-80",onClick:L})]),_:1})):Q("",!0)]),_:1})]),_:1},8,["modelValue"])])]),default:u(()=>[x("div",Qe,[s.value?(y(),C("div",{key:1,ref_key:"contentScrollEl",ref:o,class:"enchiridion-content fill-height custom-scrollbar"},[x("div",en,[c(Ye,{content:i.value},null,8,["content"])])],512)):(y(),R(l,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:u(()=>[c(Je)]),actions:u(()=>[c(F,{cols:"12",sm:"4"},{default:u(()=>[c(a,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),c(F,{cols:"12",sm:"4"},{default:u(()=>[c(a,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),c(F,{cols:"12",sm:"4"},{default:u(()=>[c(a,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1})}}}),dn=j(tn,[["__scopeId","data-v-085807fe"]]);export{dn as default};
