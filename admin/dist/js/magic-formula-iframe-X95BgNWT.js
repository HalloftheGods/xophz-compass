import{f as x,co as v,e as k,d as y,V as B,ca as M,cd as C,l as _,m as S}from"./vendor-BYnpyi9e.js";import{a as T}from"./index-Cx112yGn.js";import"./vendor-core-jhTGTKns.js";import"./vendor-vuetify-BTxFokL4.js";import"./vendor-three-DbgnMstn.js";import"./vendor-echarts-Cc1PmGFJ.js";const L=x({name:"MagicFormulaIframe",setup(){const p=v(),i=k(null);return{wpPage:y(()=>p.meta.wpPage||"forminator"),iframeRef:i,injectStyles:()=>{const e=i.value?.$el||i.value;if(e)try{const t=e.contentDocument||e.contentWindow?.document;if(!t)return;t.documentElement.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe"),t.body.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe");const o=()=>{if(!e||!t.body)return;const u=t.querySelector(".sui-wrap, .forminator-ui"),m=t.getElementById("wpbody-content"),c=t.getElementById("wpwrap");let r=0;if(u){const a=u.getBoundingClientRect();r=Math.max(r,u.scrollHeight,Math.ceil(a.height))}if(m){const a=m.getBoundingClientRect();r=Math.max(r,m.scrollHeight,Math.ceil(a.height))}if(c&&(r=Math.max(r,c.scrollHeight)),r===0&&t.body.children.length>0)for(let a=0;a<t.body.children.length;a++){const s=t.body.children[a];if(s&&s.tagName!=="SCRIPT"&&s.tagName!=="STYLE"){const g=s.offsetTop+s.offsetHeight;g>r&&(r=g)}}const w=Math.max(r+40,600);e.style.height=`${w}px`};o(),setTimeout(o,100),setTimeout(o,300),setTimeout(o,600),setTimeout(o,1200),setTimeout(o,2500);const d=new ResizeObserver(o),l=t.querySelector(".sui-wrap, .forminator-ui");l&&d.observe(l);const b=t.getElementById("wpbody-content");b&&d.observe(b),new MutationObserver(o).observe(t.body,{childList:!0,subtree:!0,attributes:!0});let n=t.getElementById("compass-sui-overrides");n||(n=t.createElement("style"),n.id="compass-sui-overrides",n.innerHTML=`
            html, body {
            ...
            .sui-modal, .sui-dialog, .sui-modal-overlay, .sui-dialog-overlay, .forminator-modal, .forminator-modal-overlay {
          ...
          `,t.head.appendChild(n))}catch(t){console.warn("[Magic Formula] Could not inject iframe styles",t)}}}}}),E={class:"magic-formula-iframe-container position-relative"};function H(p,i,f,h,e,t){const o=B("x-iframe");return M(),C("div",E,[_(o,{ref:"iframeRef",name:"compass-sub-app",class:"forminator-iframe",src:`/wp-admin/admin.php?page=${p.wpPage}&compass_iframe=1&embed=1&theme=transparent`,onLoad:p.injectStyles},null,8,["src","onLoad"]),i[0]||(i[0]=S("div",{class:"browser-overlay pointer-events-none"},null,-1))])}const G=T(L,[["render",H],["__scopeId","data-v-d5e55c70"]]);export{G as default};
