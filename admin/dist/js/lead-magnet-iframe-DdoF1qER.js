import{f as x,co as v,e as k,d as y,V as B,ca as M,cd as C,l as L,m as _}from"./vendor-BYnpyi9e.js";import{a as S}from"./index-CYxqGfjC.js";import"./vendor-core-jhTGTKns.js";import"./vendor-vuetify-BTxFokL4.js";import"./vendor-three-DbgnMstn.js";import"./vendor-echarts-Cc1PmGFJ.js";const T=x({name:"LeadMagnetIframe",setup(){const p=v(),i=k(null);return{wpPage:y(()=>p.meta.wpPage||"hustle"),iframeRef:i,injectStyles:()=>{const e=i.value?.$el||i.value;if(e)try{const t=e.contentDocument||e.contentWindow?.document;if(!t)return;t.documentElement.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe"),t.body.classList.add("compass-theme-transparent","compass-embed-mode","compass-wpmudev-iframe");const o=()=>{if(!e||!t.body)return;const u=t.querySelector(".sui-wrap, .hustle-ui"),d=t.getElementById("wpbody-content"),c=t.getElementById("wpwrap");let a=0;if(u){const r=u.getBoundingClientRect();a=Math.max(a,u.scrollHeight,Math.ceil(r.height))}if(d){const r=d.getBoundingClientRect();a=Math.max(a,d.scrollHeight,Math.ceil(r.height))}if(c&&(a=Math.max(a,c.scrollHeight)),a===0&&t.body.children.length>0)for(let r=0;r<t.body.children.length;r++){const s=t.body.children[r];if(s&&s.tagName!=="SCRIPT"&&s.tagName!=="STYLE"){const g=s.offsetTop+s.offsetHeight;g>a&&(a=g)}}const w=Math.max(a+40,600);e.style.height=`${w}px`};o(),setTimeout(o,100),setTimeout(o,300),setTimeout(o,600),setTimeout(o,1200),setTimeout(o,2500);const m=new ResizeObserver(o),l=t.querySelector(".sui-wrap, .hustle-ui");l&&m.observe(l);const b=t.getElementById("wpbody-content");b&&m.observe(b),new MutationObserver(o).observe(t.body,{childList:!0,subtree:!0,attributes:!0});let n=t.getElementById("compass-sui-overrides");n||(n=t.createElement("style"),n.id="compass-sui-overrides",n.innerHTML=`
            html, body {
          ...
          `,t.head.appendChild(n))}catch(t){console.warn("[Lead Magnet] Could not inject iframe styles",t)}}}}}),E={class:"lead-magnet-iframe-container position-relative"};function H(p,i,h,f,e,t){const o=B("x-iframe");return M(),C("div",E,[L(o,{ref:"iframeRef",name:"compass-sub-app",class:"hustle-iframe",src:`/wp-admin/admin.php?page=${p.wpPage}&compass_iframe=1&embed=1&theme=transparent`,onLoad:p.injectStyles},null,8,["src","onLoad"]),i[0]||(i[0]=_("div",{class:"browser-overlay pointer-events-none"},null,-1))])}const W=S(T,[["render",H],["__scopeId","data-v-0a94f7ce"]]);export{W as default};
